CREATE OR REPLACE FORCE VIEW COMUNI_STATI
(STATO, REGIONE, PROVINCIA, COMUNE, DENOMINAZIONE, 
 SIGLA, CAP, ISTAT, SIGLA_CFIS, DATA_SOPPRESSIONE, 
 PROVINCIA_FUSIONE, COMUNE_FUSIONE)
BEQUEATH DEFINER
AS 
SELECT 100 stato,
          pr.regione,
