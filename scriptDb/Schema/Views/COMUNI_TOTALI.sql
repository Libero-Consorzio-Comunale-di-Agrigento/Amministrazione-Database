...
(REGIONE, PROVINCIA, COMUNE, DENOMINAZIONE, SIGLA, 
 CAP, ISTAT, SIGLA_CFIS, DATA_SOPPRESSIONE, PROVINCIA_FUSIONE, 
 COMUNE_FUSIONE, DENOMINAZIONE_PROVINCIA_STATO, UTENTE_AGGIORNAMENTO, DATA_AGGIORNAMENTO)
BEQUEATH DEFINER
AS 
SELECT pr.regione,
           co.provincia_stato
