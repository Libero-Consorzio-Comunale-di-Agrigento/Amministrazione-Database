...
(UTENTE, NOMINATIVO, IS_UTENZA_TECNICA_ADS, SOGGETTO_NUMERO, SOGGETTO_NOME, 
 SOGGETTO_CODICE_FISCALE, IS_IN_STRUTTURA_ORGANIZZATIVA, IS_UTENZA_LDAP, ULTIMO_TENTATIVO, "DIRITTI: MODULO(ISTANZA)", 
 "NUOVE INFO ->", "DISABILITARE (SI/NO=VUOTO)", "NOMINATIVO LDAP(CAMBIARE)", NUOVO_SOGGETTO_ABBINARE, NUOVO_COGNOME, 
 NUOVO_NOME, NUOVO_CODICE_FISCALE)
BEQUEATH DEFINER
AS 
SELECT u.utente,
           u.nominativo,
