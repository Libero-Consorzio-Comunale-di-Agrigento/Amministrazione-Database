...
--changeset mturra:201901301231_353 runOnChange:true stripComments:false


CREATE OR REPLACE TRIGGER ALLEGATI_TIU
   before INSERT or UPDATE or DELETE on ALLEGATI
for each row
/******************************************************************************
 NOME:        ALLEGATI_TIU
 ...
 ---- ---------- ------ ------------------------------------------------------
    1 06/06/2007 MM     Gestione della sequence ALLE_SQ
******************************************************************************/
declare
               ...
               if :new.ID_ALLEGATO is not null then
                  ...
                  if found then
                     ...
                     errmsg := 'Identificazione "'||
                               :new.ID_ALLEGATO||
                               '" gia'' presente in Allegati. La registrazione  non puo'' essere inserita.';
