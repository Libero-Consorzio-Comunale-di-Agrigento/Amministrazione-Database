...
--changeset snegroni:20190612_1639 runOnChange:true stripComments:false

CREATE OR REPLACE TRIGGER UTENTI_SOGGETTI_STORICO_TIU
   /******************************************************************************
          NOME:        UTENTI_SOGGETTI_STORICO_TIU
...
DECLARE
   ...
   IS
      v_id_evento   NUMBER;
   BEGIN
      SELECT   utss_sq.NEXTVAL INTO v_id_evento FROM DUAL;
   ...
   BEGIN
      ...
      IF p_info = 'NEW'
      THEN
         INSERT INTO UTENTI_SOGGETTI_STORICO (ID_EVENTO,
                                     UTENTE,
                                     SOGGETTO,
                                     DATA,
                                     OPERAZIONE,
