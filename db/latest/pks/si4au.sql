...
--changeset mturra:201901301231_272 runOnChange:true stripComments:false endDelimiter:/


CREATE OR REPLACE PACKAGE SI4AU AS
/* compatibile con appeon*/
 ...
 FUNCTION si4_authenticate(username IN VARCHAR2, password IN VARCHAR2) RETURN NUMBER; -- Utilizzata da Appeon
END SI4AU;
/
