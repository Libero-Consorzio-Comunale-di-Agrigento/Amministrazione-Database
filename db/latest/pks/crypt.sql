...
--changeset snegroni:201905021606 runOnChange:true stripComments:false endDelimiter:/
...
/******************************************************************************
 ...
 06 24/05/2022  FM    Aggiunta funzione GET_TOKEN_SSO Feature #53794
******************************************************************************/
...
******************************************************************************/
   ...
   ******************************************************************************/
   ...
   FUNCTION get_token_sso(p_nominativo in VARCHAR2)
      RETURN VARCHAR2;
END;
/
