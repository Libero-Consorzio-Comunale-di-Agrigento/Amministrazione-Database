...
--changeset mturra:201901301231_310 runOnChange:true stripComments:false endDelimiter:/


create or replace package xslstylesheetcover is
PROCEDURE freeStylesheet(id number) is language java name 'oracle.xml.parser.plsql.XSLStylesheetCover.freeStylesheet(int)';
FUNCTION newStylesheetFromDoc(xmldoc number, url varchar2, err in out varchar2) return number is language java name 'oracle.xml.parser.plsql.XSLStylesheetCover.newStylesheetFromDoc(long, java.lang.String, java.lang.String[]) returns int';
