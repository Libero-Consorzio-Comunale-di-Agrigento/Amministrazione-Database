...
--changeset mturra:201901301231_305 runOnChange:true stripComments:false endDelimiter:/


create or replace package xmlparsercover is
...
PROCEDURE parseDTDBuffer(id number, dtd varchar2, root varchar2, err in out varchar2) is language java name 'oracle.xml.parser.plsql.XMLParserCover.parseDTDBuffer(int, oracle.sql.CHAR, java.lang.String, java.lang.String[])';
...
PROCEDURE setDoctype(id number, dtd number) is language java name 'oracle.xml.parser.plsql.XMLParserCover.setDoctype(int, long)';
FUNCTION getDoctype(id number) return number is language java
name 'oracle.xml.parser.plsql.XMLParserCover.getDoctype(int) returns long';
FUNCTION getDocument(id number) return number is language java
name 'oracle.xml.parser.plsql.XMLParserCover.getDocument(int) returns long';
FUNCTION getJavaReleaseVersion return varchar2 is language java
