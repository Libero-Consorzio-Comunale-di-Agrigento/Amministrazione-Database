...
--changeset mturra:201901301231_214 runOnChange:true stripComments:false endDelimiter:/
...
/******************************************************************************
 ...
 19   27/05/2005 AO     Modificata function get_page per gestione link con parametri
 20   27/01/2006 AO     Modificata function get_blocco per gestione espansione nodi di menu
                        senza riposizionamento su home page
                  Modificata get_albero_menu per gestione menu da si4web
 21   20/12/2006 AO     Modificata get_blocco
                      Corretta get_page
...
d_revisione VARCHAR2(30) := '23   16/06/2020';
