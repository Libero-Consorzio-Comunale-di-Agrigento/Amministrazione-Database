...
--changeset mturra:201901301231_217 runOnChange:true stripComments:false endDelimiter:/
...
/****************************************************************************************
 ...
 3    27/01/2006 AO     Versione 2005.05.3 modificata get_albero_sezioni e get_corpo
 4    20/05/2006 AO     Modificata get_blocco_modulistica
 5    26/03/2006 AO     Aggiunta funzione is_empty
                        Modificata get_menu e get_corpo con utilizzo di is_empty
...
d_revisione VARCHAR2(30) := '7   16/06/2020';
...
RETURN VARCHAR2;
FUNCTION IS_EMPTY(P_ID_SEZIONE NUMBER, P_UTENTE VARCHAR2) RETURN number;
END Amv_Sezione;
/
