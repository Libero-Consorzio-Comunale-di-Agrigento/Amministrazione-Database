...
--changeset mturra:201901301231_282 runOnChange:true stripComments:false endDelimiter:/
...
CREATE OR REPLACE package spid_handler is
    /******************************************************************************
     ...
     3    28/02/2018 AD     Aggiunto parametro telefono residenza in conferma dei dati anagrafici
                                       del soggetto
     4    09/05/2022 AD      Aggiunta chec_soggetto per verificare se riutilizzare i soggetti presenti
                                        in anagrafica in base all'ultimo tentativo di accesso
    ******************************************************************************/
    s_revisione AFC.t_revision := 'V1.04';
    -- Version and revision
    function versione return AFC.t_revision;
    function check_soggetto(p_soggetto in number, p_profilo in varchar2 default null) return number;
