...
--changeset mturra:201901301231_151 runOnChange:true stripComments:false
...
/************************************************************************************
   ...
   DESCRIZIONE:   Modifica il flag 'broken' del job ( i job 'broken' non vengono
                  ...
                  cui il job sara eseguito la volta successiva con la funzione
   ...
   ARGOMENTI:      Nome            Descrizione
                  ...
                  p_broken         Indica se il job deve essere bloccato (TRUE) o
                                 sbloccato (FALSE)
                  p_next_date      Data in cui il job sara eseguito la volta   successiva
