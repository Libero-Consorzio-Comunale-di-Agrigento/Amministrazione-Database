...
--changeset mturra:201901301231_125 runOnChange:true stripComments:false


CREATE OR REPLACE PACKAGE BODY Codice_Fiscale IS
/******************************************************************************
 NOME:        CODICE_FISCALE.
...
/******************************************************************************
 ...
 7   07/11/2018 MTurra Gestione Omocodie
******************************************************************************/
   ( p_codice_fiscale varchar2) return integer
   is
   begin
      return TO_NUMBER(GET_CF_CHARTONUMBER(SUBSTR(p_codice_fiscale,10,2)));
   end;
...
******************************************************************************/
   ...
   begin
      return instr('ABCDEHLMPRST', SUBSTR(p_codice_fiscale,9,1));
   end;
...
******************************************************************************/
   ...
   is
   begin
      return TO_NUMBER(GET_CF_CHARTONUMBER(SUBSTR(p_codice_fiscale,7,2)));
   end;
   FUNCTION CONTROLLO
/******************************************************************************
 NOME:        CONTROLLO.
                    ...
                    and not exists (select 'x'
                                     ...
                                     where provincia_stato = p_provincia_nas
                                       ...
                                       and nvl(c.data_soppressione, to_date('3333333','j'))<
                                         nvl(comuni.data_soppressione, to_date('3333333','j')))
            ;
