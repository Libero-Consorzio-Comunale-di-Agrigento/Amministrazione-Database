...
--changeset snegroni:201912061138 runOnChange:true stripComments:false
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(1) from user_objects where object_name='SO4_UTIL' and object_type = 'PACKAGE BODY';
