...
--changeset mturra:201901301231_181 runOnChange:true stripComments:false
   ...
   ******************************************************************************/
   ...
   /******************************************************************************
    ...
    DESCRIZIONE:  Conversione di una stringa nella corrispondente sequenza di
                  escape XML utilizzando le entitÃ '' del tipo &#n; dove n
   ...
   ******************************************************************************/
   ...
   /******************************************************************************
    ...
    DESCRIZIONE:  Conversione di una stringa nella corrispondente stringa in cui
                  ...
                  i caratteri di escape XML utilizzando le entitÃ '' del tipo &#n;
