...
it.finmatica.sa4.thread.CcsThreadShared instance =(it.finmatica.sa4.thread.CcsThreadShared) it.finmatica.sa4.thread.CcsThreadShared.getInstance();
instance.setSessionId(request.getSession(true).getId());
instance.setClientIp(request.getRemoteAddr());
instance.setClientName(request.getRemoteUser());
StringBuffer params = new StringBuffer();
params.append(request.getRequestURI());
if (request.getQueryString()!=null){
	params.append("?"+request.getQueryString());
}
instance.setHttpRequest(params.toString());
instance.setProgetto((String)request.getSession(true).getAttribute("Progetto"));
instance.setIstanza((String)request.getSession(true).getAttribute("Istanza"));
instance.setModulo((String)request.getSession(true).getAttribute("Modulo"));
instance.setUtente((String)request.getSession(true).getAttribute("Utente"));
