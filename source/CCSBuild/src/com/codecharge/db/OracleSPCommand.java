/******************************************************************************
 ...
 ---- ---------- ------ --------------------------------------------------------
  ...
  2    08/02/2006 AO     Gestione messaggio di errore su ritorno dei refcursor da procedure
  3    01/06/2006 AO     Gestione registrazione accessi
******************************************************************************/
...
public class OracleSPCommand extends SPCommand {
    ...
    private String utente;	//Rev.3
    private String modulo;	//Rev.3
    private String istanza;	//Rev.3
    private String progetto;	//Rev.3
    private String ente;	//Rev.3
    ...
    public void addParameter( String paramName, Parameter param, int sqlType, int scale, int direction ) {
        if ( param != null ) {
			...
			if(value instanceof String&&(!paramName.endsWith("NOSANITIZE"))){
				value=StringUtils.sanitize((String)value);
			}
		    try{value=StringUtils.sanitize((String)value);}catch(Exception e){}
...
//                                } catch ( SQLException sqle ) {
                                    ...
                                    // conn.addError( "Exception by cstmt.getObject(" + countParams + ") :"+ sqle.getMessage() + "<br>" ); //Rev.2
                                    return;
                                }
...
// Rev.1 : Fine    
  ...
  private void registraAccesso() throws SQLException {
	...
	cstmtAccesso.setString(4, sqlAccesso);
