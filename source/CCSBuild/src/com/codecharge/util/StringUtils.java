...
//End StringUtils: decodeURL
	 ...
	 if(html != null){
         try{
         Class c = Class.forName("it.finmatica.sa4.Sanitizer");
            Class[] argTypes = new Class[] { String.class };
            java.lang.reflect.Method m = c.getDeclaredMethod("sanitize", argTypes);
            Object[] argValue = new Object[] { html };
            Object result = m.invoke(null,argValue);
            return result.toString();
         }catch(Exception e){
   ...
   public static String cryptAndCSRF(String content, String tokenAntiCSRF, boolean cryptHref) {
        try {
            Class c = Class.forName("it.finmatica.sa4.Sanitizer");
            Class[] argTypes = new Class[]{String.class, String.class, boolean.class};
            java.lang.reflect.Method m = c.getDeclaredMethod("cryptAndCSRF", argTypes);
            Object[] argValue = new Object[]{content, tokenAntiCSRF, new Boolean(cryptHref)};
            Object result = m.invoke(null, argValue);
            return result.toString();
        } catch (Exception e) {
            return content;
  ...
  public static String cryptAndCSRFNoForm(String content, String tokenAntiCSRF, boolean cryptHref) {
        try {
            Class c = Class.forName("it.finmatica.sa4.Sanitizer");
            Class[] argTypes = new Class[]{String.class, String.class, boolean.class};
            java.lang.reflect.Method m = c.getDeclaredMethod("cryptAndCSRFNoForm", argTypes);
            Object[] argValue = new Object[]{content, tokenAntiCSRF, new Boolean(cryptHref)};
            Object result = m.invoke(null, argValue);
            return result.toString();
        } catch (Exception e) {
    ...
    public static String decryptB64(String toDecrypt) {
        try {
            Class c = Class.forName("it.finmatica.sa4.Sanitizer");
            Class[] argTypes = new Class[]{String.class};
            java.lang.reflect.Method m = c.getDeclaredMethod("decryptB64", argTypes);
            Object[] argValue = new Object[]{toDecrypt};
            Object result = m.invoke(null, argValue);
            return result.toString();
        } catch (Exception e) {
            return toDecrypt;
    ...
    public static String encryptB64(String toCrypt) {
        try {
            Class c = Class.forName("it.finmatica.sa4.Sanitizer");
            Class[] argTypes = new Class[]{String.class};
            java.lang.reflect.Method m = c.getDeclaredMethod("encryptB64", argTypes);
            Object[] argValue = new Object[]{toCrypt};
            Object result = m.invoke(null, argValue);
            return result.toString();
        } catch (Exception e) {
            return toCrypt;
 ...
 public static String decryptB64URL(String toDecrypt) {
        try {
            Class c = Class.forName("it.finmatica.sa4.Sanitizer");
            Class[] argTypes = new Class[]{String.class};
            java.lang.reflect.Method m = c.getDeclaredMethod("decryptB64URL", argTypes);
            Object[] argValue = new Object[]{toDecrypt};
            Object result = m.invoke(null, argValue);
            return result.toString();
        } catch (Exception e) {
    ...
    public static String getParamValue(String queryString, String param) {
        try {
            ...
            java.lang.reflect.Method m = c.getDeclaredMethod("getParamValue", argTypes);
            Object[] argValue = new Object[]{queryString,param};
            Object result = m.invoke(null, argValue);
            return result.toString();
        } catch (Exception e) {
            return "";
    ...
    public static String TOKEN_ANTI_CSRF() {
        try {
            return (String) Class.forName("it.finmatica.sa4.htmlparser.HtmlCrypt").getField("TOKEN_ANTI_CSRF").get(Class.forName("it.finmatica.sa4.htmlparser.HtmlCrypt"));
        } catch (Exception e) {
            return "sa4tk";
        }
    }
