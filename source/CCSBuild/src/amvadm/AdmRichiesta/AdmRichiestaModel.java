...
//AD4_RICHIESTE_ABILITAZIONEGrid grid @30-AAF406C5
        ...
        */
        {
            ...
            com.codecharge.components.Label SECONDA_PWD__69 = new com.codecharge.components.Label("SECONDA_PWD", "SECONDA_PWD", this );
            SECONDA_PWD__69.setType( com.codecharge.components.ControlType.TEXT );
            SECONDA_PWD__69.setHtmlEncode( true );
            SECONDA_PWD__69.addControlListener( new AD4_RICHIESTE_ABILITAZIONEGridSECONDA_PWDHandler());
            AD4_RICHIESTE_ABILITAZIONEGrid.add(SECONDA_PWD__69);

            com.codecharge.components.Label NOTE__83 = new com.codecharge.components.Label("NOTE", "NOTE", this );
            NOTE__83.setType( com.codecharge.components.ControlType.TEXT );
            NOTE__83.setHtmlEncode( true );
            AD4_RICHIESTE_ABILITAZIONEGrid.add(NOTE__83);
...
//AD4_RICHIESTE_ABILITAZIONERecord record @7-53CB3383
        ...
        */
        {
            ...
            AD4_RICHIESTE_ABILITAZIONERecord.addRecordListener(new AD4_RICHIESTE_ABILITAZIONERecordRecordHandler());

            com.codecharge.components.Hidden USER_ORACLE__80 = new com.codecharge.components.Hidden("USER_ORACLE", "USER_ORACLE", this );
            USER_ORACLE__80.setType( com.codecharge.components.ControlType.TEXT );
            USER_ORACLE__80.setHtmlEncode( true );
            AD4_RICHIESTE_ABILITAZIONERecord.add( USER_ORACLE__80 );
            ...
            com.codecharge.components.Link Stampa__78 = new com.codecharge.components.Link("Stampa", "", this );
            Stampa__78.setType( com.codecharge.components.ControlType.TEXT );
            Stampa__78.setHtmlEncode( true );
            Stampa__78.setHrefSourceValue( "AdmRichiestaPrint" + Names.ACTION_SUFFIX );
            Stampa__78.setHrefType( "Page" );
            Stampa__78.setConvertRule("Relative");
            Stampa__78.setPreserveType(PreserveParameterType.GET);
            AD4_RICHIESTE_ABILITAZIONERecord.add( Stampa__78 );
            ...
            Annulla__46.addExcludeParam( "ID" );
            ...
            com.codecharge.components.Button Archivia__75 = new com.codecharge.components.Button("Archivia", this);
            Archivia__75.addButtonListener(new AD4_RICHIESTE_ABILITAZIONERecordArchiviaHandler());
            Archivia__75.addExcludeParam( "ccsForm" );
            Archivia__75.addExcludeParam( "Archivia" );
            Archivia__75.setOperation( "Update" );
            AD4_RICHIESTE_ABILITAZIONERecord.add( Archivia__75 );
