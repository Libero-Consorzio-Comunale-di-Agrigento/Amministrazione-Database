...
//attributes of DataObject @17-D75AB6BC
...
//properties of DataObject @17-88E52EBB
...
//loadDataBind @17-597AF1B1
        if ( record == null || record.isEmpty() ) {
            ...
            row.setSTRINGA_ALIAS(Utils.convertToString(ds.parse(record.get("STRINGA"), row.getSTRINGA_ALIASField())));
...
//getParameterByName @17-0D39A322
