//PREFERENZA_NEW DataSource @45-454E111D
...
//End PREFERENZA_NEW DataSource

//class DataObject Header @45-861B2E47
public class PREFERENZA_NEWDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @45-351BC2DD
    ...
    private PREFERENZA_NEWRow row = new PREFERENZA_NEWRow();

//End attributes of DataObject

//properties of DataObject @45-CDBBF442
    ...
    public PREFERENZA_NEWRow getRow() {
        return row;
    }

    public void setRow( PREFERENZA_NEWRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @45-5222287F
    public PREFERENZA_NEWDataObject(Page page) {
        super(page);
    }
//End constructor
...
//loadDataBind @45-25D9B648
        if ( record == null || record.isEmpty() ) {
            empty = true;
        } else {
            row.setSTRINGA_LABEL(Utils.convertToString(ds.parse(record.get("STRINGA_ALIAS"), row.getSTRINGA_LABELField())));
