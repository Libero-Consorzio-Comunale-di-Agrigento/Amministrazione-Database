...
//attributes of DataObject @6-D9719BC0
    ...
    TextField postNOTE_NOTIFICA = new TextField(null, null);
...
//properties of DataObject @6-85638F33
    ...
    public void  setPostNOTE_NOTIFICA( String param ) {
        this.postNOTE_NOTIFICA.setValue( param );
    }

    public void  setPostNOTE_NOTIFICA( Object param ) {
        this.postNOTE_NOTIFICA.setValue( param );
    }

    public void  setPostNOTE_NOTIFICA( Object param, Format ignore ) {
        this.postNOTE_NOTIFICA.setValue( param );
    }
...
//loadDataBind @6-F611D3B9
        if ( record == null || record.isEmpty() ) {
            ...
            row.setNOTE_NOTIFICA(Utils.convertToString(ds.parse(record.get("NOTE_NOTIFICA"), row.getNOTE_NOTIFICAField())));
        }
//End loadDataBind
...
//update @6-A84FA9A6
        boolean update() {
            ...
            command.setSql("UPDATE AD4_RICHIESTE_ABILITAZIONE SET TIPO_NOTIFICA = {postTIPO_NOTIFICA}, INDIRIZZO_NOTIFICA = {postINDIRIZZO_NOTIFICA}, NOTE_NOTIFICA = {postNOTE_NOTIFICA}");
            ...
            command.addParameter("postNOTE_NOTIFICA", postNOTE_NOTIFICA);
...
//getParameterByName @6-14E6D362
        public Parameter getParameterByName(String name, ParameterSource parameterSource) {
            ...
            if ( "NOTE_NOTIFICA".equals(name) && "post".equals(prefix) ) {
                param = postNOTE_NOTIFICA;
            } else if ( "NOTE_NOTIFICA".equals(name) && prefix == null ) {
                param = postNOTE_NOTIFICA;
            }
