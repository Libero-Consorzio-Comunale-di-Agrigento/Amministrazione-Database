...
//AD4_RICHIESTE_ABILITAZIONE Record: bind @6-E6089FF4
            public void bind(com.codecharge.components.Component model, AD4_RICHIESTE_ABILITAZIONERow row ) {
                ...
                if ( this.valid ) {
                    ...
                    model.getControl("NOTE_NOTIFICA").setValue(row.getNOTE_NOTIFICA());
                }
            }
//End AD4_RICHIESTE_ABILITAZIONE Record: bind

//AD4_RICHIESTE_ABILITAZIONE Record: getRowFieldByName @6-EE360A00
            public Object getRowFieldByName( String name, AD4_RICHIESTE_ABILITAZIONERow row ) {
                ...
                } else if ( "NOTE_NOTIFICA".equals(name) ) {
                    value = row.getNOTE_NOTIFICA();
                }
                return value;
            }
...
//AD4_RICHIESTE_ABILITAZIONE Record: method update body @6-B32DBCC8
            if (!model.isAllowUpdate()) return;
            boolean isErrors = false;
            AD4_RICHIESTE_ABILITAZIONEDataObject ds = new AD4_RICHIESTE_ABILITAZIONEDataObject(page);
            ds.setComponent( model );
            ...
            ds.setPostNOTE_NOTIFICA( page.getHttpPostParams().getParameter("NOTE_NOTIFICA"), null );
            ds.setUrlID( page.getHttpGetParams().getParameter("ID") );
...
//AD4_RICHIESTE_ABILITAZIONE Record: method validate @6-1C1E99C6
        boolean validate() {
            ...
            com.codecharge.components.TextArea NOTE_NOTIFICA = (com.codecharge.components.TextArea) model.getChild( "NOTE_NOTIFICA" );
            if (! NOTE_NOTIFICA.validate()) { isControlError = true; }
