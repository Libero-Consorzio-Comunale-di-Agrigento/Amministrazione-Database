...
//load @98-16FD094A
    boolean load() {
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( SELECT m.descrizione||' - '||i.descrizione servizio FROM ad4_moduli m,  "
                                                         + "            ad4_istanze i WHERE m.modulo = '{MOD}' AND i.istanza = '{IST}' ) cnt " );
