...
//attributes of DataObject @6-512F0DB6
...
//properties of DataObject @6-A3059C9F
...
//load @6-D621C453
    boolean load() {
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( select to_char(trunc(acce.DATA),'dd/mm/yyyy') DES_ACCESSO ,  "
                                                         ...
                                                         + "            AD4_MODULI modu ,  "
                                                         + "            AD4_ISTANZE ista where acce.utente = '{MVUTE}' and modu.modulo = acce.modulo and modu.progetto = '{Progetto}' and ista.istanza = acce.istanza group by trunc(acce.DATA), modu.DESCRIZIONE,ista.DESCRIZIONE  ) cnt " );
