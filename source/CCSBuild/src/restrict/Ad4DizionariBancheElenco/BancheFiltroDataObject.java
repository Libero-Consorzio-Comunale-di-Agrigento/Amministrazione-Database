//BancheFiltro DataSource @3-9579225C
...
//End BancheFiltro DataSource

//class DataObject Header @3-0C0D1CED
public class BancheFiltroDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @3-3B8C7026
    

    TextField urlS_BANCA = new TextField(null, null);
    

    private BancheFiltroRow row = new BancheFiltroRow();

//End attributes of DataObject

//properties of DataObject @3-D5A43F39
    ...
    public BancheFiltroRow getRow() {
        return row;
    }

    public void setRow( BancheFiltroRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @3-57A65F12
    public BancheFiltroDataObject(Page page) {
        super(page);
    }
//End constructor
...
//load @3-18521152
    boolean load() {
        ...
        command.setSql( "select ad4_ccs.filter_search('{s_BANCA}') filter_search "
                    + "      ,'{s_BANCA}'                        s_banca "
                    + "  from dual" );
