//AttributoHeaderGridHandler @2-D1257E9C
...
//Set values for static controls @2-33FCE37F
        e.getGrid().getControl("Indietro").setValue("Indietro");
        e.getGrid().getLink("Indietro").getParameter("MVPG").setValue(( "Ad4DizionariSportelliElenco" ));
