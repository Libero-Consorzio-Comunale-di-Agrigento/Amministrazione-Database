//AttributoHeaderGridHandler @2-077AD648
...
//Set values for static controls @2-CC73EBED
        e.getGrid().getControl("Indietro").setValue("Indietro");
        e.getGrid().getLink("Indietro").getParameter("MVPG").setValue(( "Ad4DizionariBancheElenco" ));
