//RegioniFiltro DataSource @3-A66046EE
...
//End RegioniFiltro DataSource

//class DataObject Header @3-D0ADCC78
public class RegioniFiltroDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @3-4BD62CD3
    

    TextField urlS_REGIONE = new TextField(null, null);
    

    private RegioniFiltroRow row = new RegioniFiltroRow();

//End attributes of DataObject

//properties of DataObject @3-6E0DDAFE
    ...
    public RegioniFiltroRow getRow() {
        return row;
    }

    public void setRow( RegioniFiltroRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @3-4FBF8341
    public RegioniFiltroDataObject(Page page) {
        super(page);
    }
//End constructor
...
//load @3-A9C60EA1
    boolean load() {
        ...
        command.setSql( "select ad4_ccs.filter_search('{s_REGIONE}') filter_search "
                    + "      ,'{s_REGIONE}'                        s_regione "
                    + "  from dual" );
