...
//AD4_UTENTI Record: bind @6-96A285C5
...
//AD4_UTENTI Record: getRowFieldByName @6-90A3126C
...
//AD4_UTENTI Record: method validate @6-982CA1E2
        boolean validate() {
            model.fireOnValidateEvent();
            boolean isControlError = false;

            com.codecharge.components.Hidden IS_LDAPUSER = (com.codecharge.components.Hidden) model.getChild( "IS_LDAPUSER" );
            if (! IS_LDAPUSER.validate()) { isControlError = true; }
