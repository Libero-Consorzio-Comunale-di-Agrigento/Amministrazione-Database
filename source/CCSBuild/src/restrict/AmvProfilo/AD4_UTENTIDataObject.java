...
//load @6-52947DAB
    boolean load() {
        ...
        command.setSql( "SELECT u.NOMINATIVO NOMINATIVO "
                    ...
                    + ", r.DESCRIZIONE RUOLO "
                    + ",  "
                    + "accesso.is_ldapuser(u.NOMINATIVO) IS_LDAPUSER "
                    + "FROM AD4_UTENTI u,  "
                    + "AD4_RUOLI r  "
...
//loadDataBind @6-080AA8AE
        if ( record == null || record.isEmpty() ) {
            ...
            row.setIS_LDAPUSER(Utils.convertToString(ds.parse(record.get("IS_LDAP_USER"), row.getIS_LDAPUSERField())));
