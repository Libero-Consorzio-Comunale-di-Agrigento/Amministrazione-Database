//Ad4DizionariComuneBreveTraduzioneAction imports @1-DFBE5805
...
//End Ad4DizionariComuneBreveTraduzioneAction imports

//Ad4DizionariComuneBreveTraduzioneAction class @1-23B3FA45
public class Ad4DizionariComuneBreveTraduzioneAction extends Action {

//End Ad4DizionariComuneBreveTraduzioneAction class

//Ad4DizionariComuneBreveTraduzioneAction: method perform @1-1EBBFACD
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new Ad4DizionariComuneBreveTraduzioneModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "Ad4DizionariComuneBreveTraduzioneModel", page );
...
//End Ad4DizionariComuneBreveTraduzioneAction: method perform

//Ad4DizionariComuneBreveTraduzioneAction: call children actions @1-E0E9B835
        if (result == null) {
...
//End Ad4DizionariComuneBreveTraduzioneAction: call children actions
...
//Ad4DizionariComuneBreveTraduzione Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End Ad4DizionariComuneBreveTraduzione Page: method validate

//Ad4DizionariComuneBreveTraduzioneAction Tail @1-FCB6E20C
}
//End Ad4DizionariComuneBreveTraduzioneAction Tail
