//Ad4DizionariComuneBreveTraduzioneModel imports @1-1CA49352
...
//End Ad4DizionariComuneBreveTraduzioneModel imports

//Ad4DizionariComuneBreveTraduzioneModel class head @1-98E5C6E6
public class Ad4DizionariComuneBreveTraduzioneModel extends com.codecharge.components.Page {
    public Ad4DizionariComuneBreveTraduzioneModel() {
        this( new CCSLocale(), null );
    }

    public Ad4DizionariComuneBreveTraduzioneModel(CCSLocale locale) {
        this( locale, null );
    }

    public Ad4DizionariComuneBreveTraduzioneModel( CCSLocale locale, HttpServletResponse response ) {
//End Ad4DizionariComuneBreveTraduzioneModel class head

//page settings @1-1CF23842
        super("Ad4DizionariComuneBreveTraduzione", locale );
        setResponse(response);
        {
        } // end page
//End page settings

//ComuneImposta record @5-E3F37312
        ...
        */
        {
            ...
            ComuneImposta.setReturnPage("Ad4DizionariComuneBreveTraduzione" + Names.ACTION_SUFFIX);
            ...
            com.codecharge.components.Label DENOMINAZIONE__44 = new com.codecharge.components.Label("DENOMINAZIONE", "DENOMINAZIONE_BREVE", this );
...
//Ad4DizionariComuneBreveTraduzioneModel class tail @1-F5FC18C5
    }
}
//End Ad4DizionariComuneBreveTraduzioneModel class tail
