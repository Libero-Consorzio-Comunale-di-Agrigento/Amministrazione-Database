//ComuneImposta DataSource @5-160025FB
...
//attributes of DataObject @5-AB83A815
    ...
    TextField ctrlDATA_ISTITUZIONE = new TextField(null, null);
...
//properties of DataObject @5-400117A6
    ...
    public void  setCtrlDATA_ISTITUZIONE( String param ) {
        this.ctrlDATA_ISTITUZIONE.setValue( param );
    }

    public void  setCtrlDATA_ISTITUZIONE( Object param ) {
        this.ctrlDATA_ISTITUZIONE.setValue( param );
    }

    public void  setCtrlDATA_ISTITUZIONE( Object param, Format ignore ) {
        this.ctrlDATA_ISTITUZIONE.setValue( param );
    }
...
//load @5-C34353FD
    boolean load() {
        ...
        command.setSql( "select provincia_stato "
                    ...
                    + "      ,denominazione "
                    + "      ,  "
                    + "ad4_ccs.get_link_traduzione_comune(provincia_stato,comune) open_traduzione "
                    + "      ,denominazione_breve "
                    + "      ,ad4_ccs.get_link_traduzione_comune_br(provincia_stato,comune) open_traduzione_br "
                    + "      ,capoluogo_provincia "
                    + "      ,cap "
                    + "      ,provincia_tribunale "
                    + "      ,comune_tribunale "
...
//loadDataBind @5-9C2DAFED
        if ( record == null || record.isEmpty() ) {
            ...
            row.setTRADUZIONE_BREVE(Utils.convertToString(ds.parse(record.get("OPEN_TRADUZIONE_BR"), row.getTRADUZIONE_BREVEField())));
            ...
            row.setDATA_ISTITUZIONE(Utils.convertToString(ds.parse(record.get("DATA_ISTITUZIONE"), row.getDATA_ISTITUZIONEField())));
...
//insert @5-BFBE4E9B
        boolean insert() {
            ...
            if ( StringUtils.isEmpty( (String) row.getDATA_ISTITUZIONE()) ) row.setDATA_ISTITUZIONE( "" );
            command.addParameter( "IN_DATA_ISTITUZIONE", row.getDATA_ISTITUZIONEField(), java.sql.Types.CHAR, 0, SPParameter.INPUT_PARAMETER );
...
//getParameterByName @5-998412BB
        public Parameter getParameterByName(String name, ParameterSource parameterSource) {
            ...
            if ( "DATA_ISTITUZIONE".equals(name) && "ctrl".equals(prefix) ) {
                param = ctrlDATA_ISTITUZIONE;
            } else if ( "DATA_ISTITUZIONE".equals(name) && prefix == null ) {
                param = ctrlDATA_ISTITUZIONE;
            }
