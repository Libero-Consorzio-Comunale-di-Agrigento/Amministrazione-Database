//Ad4DizionariBancheGuidaAction imports @1-D6860F5B
...
//End Ad4DizionariBancheGuidaAction imports

//Ad4DizionariBancheGuidaAction class @1-9482F620
public class Ad4DizionariBancheGuidaAction extends Action {

//End Ad4DizionariBancheGuidaAction class

//Ad4DizionariBancheGuidaAction: method perform @1-D0F7F5C2
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new Ad4DizionariBancheGuidaModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "Ad4DizionariBancheGuidaModel", page );
...
//End Ad4DizionariBancheGuidaAction: method perform

//Ad4DizionariBancheGuidaAction: call children actions @1-292B923C
        if (result == null) {
...
//End Ad4DizionariBancheGuidaAction: call children actions
...
//Guida Grid: method bind @2-07FE31D5
...
//Guida Directory: getRowFieldByName @2-377C4072
...
//Ad4DizionariBancheGuida Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End Ad4DizionariBancheGuida Page: method validate

//Ad4DizionariBancheGuidaAction Tail @1-FCB6E20C
}
//End Ad4DizionariBancheGuidaAction Tail
