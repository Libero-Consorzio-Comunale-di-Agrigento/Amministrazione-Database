//Ad4DizionariAslGuidaAction imports @1-B40860FA
...
//End Ad4DizionariAslGuidaAction imports

//Ad4DizionariAslGuidaAction class @1-CC178798
public class Ad4DizionariAslGuidaAction extends Action {

//End Ad4DizionariAslGuidaAction class

//Ad4DizionariAslGuidaAction: method perform @1-0D9079E6
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new Ad4DizionariAslGuidaModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "Ad4DizionariAslGuidaModel", page );
...
//End Ad4DizionariAslGuidaAction: method perform

//Ad4DizionariAslGuidaAction: call children actions @1-292B923C
        if (result == null) {
...
//End Ad4DizionariAslGuidaAction: call children actions
...
//Guida Grid: set where parameters @2-C14553B4
...
//Ad4DizionariAslGuida Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End Ad4DizionariAslGuida Page: method validate

//Ad4DizionariAslGuidaAction Tail @1-FCB6E20C
}
//End Ad4DizionariAslGuidaAction Tail
