//Ad4DizionariComuniElencoAction imports @1-4CDF5FAF
...
//Ad4DizionariComuniElencoAction: call children actions @1-7AF09968
...
//ListBoxAction @26-59290399
        protected void reads_PROVINCIA(com.codecharge.components.ListBox model) {
            ...
            command.setSql( "select provincia "
                        + "      ,denominazione "
                        + "  from ad4_province "
                        + " where nvl({s_PROVINCIA},0) < 200 "
                        + "union "
                        + "select stato_territorio provincia "
                        + "     ,  "
                        + "denominazione "
                        + "  from ad4_stati_territori "
                        + " where {s_PROVINCIA} >= 200" );
            if ( urlS_PROVINCIA.getObjectValue() == null ) urlS_PROVINCIA.setValue( -1 );
