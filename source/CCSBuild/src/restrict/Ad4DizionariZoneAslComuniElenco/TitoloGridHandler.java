...
//Set values for static controls @40-43456DC7
        e.getGrid().getControl("Aggiungi").setValue("Nuovo");
        e.getGrid().getLink("Aggiungi").getParameter("MVPG").setValue(( "Ad4DizionariZonaAslComuneImposta" ));
