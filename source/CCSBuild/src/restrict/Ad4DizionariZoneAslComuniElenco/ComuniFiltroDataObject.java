//ComuniFiltro DataSource @3-7929C798
...
//attributes of DataObject @3-8DC50040
...
//properties of DataObject @3-C6357B75
...
//load @3-54AF896C
    boolean load() {
        ...
        command.setSql( "select ad4_ccs.filter_search('{s_COMUNE}') filter_search "
                    + "      ,'{s_COMUNE}'                         s_comune "
                    + "  from dual" );
