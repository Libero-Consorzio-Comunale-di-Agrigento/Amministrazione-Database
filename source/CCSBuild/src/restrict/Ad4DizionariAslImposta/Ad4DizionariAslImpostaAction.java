//Ad4DizionariAslImpostaAction imports @1-57F0C826
...
//Ad4DizionariAslImpostaAction: call children actions @1-ADF04898
        if (result == null) {
        ...
        if ( page.getChild( "Ad4DizionariAslComuniElenco" ).isVisible() ) {
            ...
            restrict.Ad4DizionariAslComuniElenco.Ad4DizionariAslComuniElencoAction Ad4DizionariAslComuniElenco = new restrict.Ad4DizionariAslComuniElenco.Ad4DizionariAslComuniElencoAction();
...
//ListBoxAction @40-EE0D5B44
        protected void readREGIONE_ASL(com.codecharge.components.ListBox model) {

            LongField urlS_REGIONE = new LongField(null, null);
            
            try {
                urlS_REGIONE.setValue( page.getHttpGetParams().getParameter("s_REGIONE"), page.getCCSLocale().getFormat("Integer") );
            ...
            command.setSql( "select regione "
                        + "      ,denominazione "
                        + "  from ad4_regioni "
                        + "where regione = nvl({s_REGIONE},regione) "
                        + "" );
            if ( urlS_REGIONE.getObjectValue() == null ) urlS_REGIONE.setValue( null );
