//Ad4DizionariAslImpostaView imports @1-D0E6E0BA
...
//Ad4DizionariAslImpostaView: method show @1-67A6AA9A
    public String show( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        this.tmplPath = "/restrict/Ad4DizionariAslImposta.html";
        ...
        if ( page.getChild( "Ad4DizionariAslComuniElenco" ).isVisible() ) {
            restrict.Ad4DizionariAslComuniElenco.Ad4DizionariAslComuniElencoView Ad4DizionariAslComuniElenco = new restrict.Ad4DizionariAslComuniElenco.Ad4DizionariAslComuniElencoView();
