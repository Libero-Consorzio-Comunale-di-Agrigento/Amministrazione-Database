//AttributoHeaderGridHandler @2-51BF208E
...
//Set values for static controls @2-013E0449
        e.getGrid().getControl("Indietro").setValue("Indietro");
        e.getGrid().getLink("Indietro").getParameter("MVPG").setValue(( "Ad4DizionariRegioniElenco" ));
