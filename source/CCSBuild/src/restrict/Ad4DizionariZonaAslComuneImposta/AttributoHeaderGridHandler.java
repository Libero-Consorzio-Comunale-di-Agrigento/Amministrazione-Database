//AttributoHeaderGridHandler @44-85834CD1
...
//Set values for static controls @44-47BCABFD
        e.getGrid().getControl("Indietro").setValue("Indietro");
        e.getGrid().getLink("Indietro").getParameter("MVPG").setValue(( "Ad4DizionariZonaAslImposta" ));
