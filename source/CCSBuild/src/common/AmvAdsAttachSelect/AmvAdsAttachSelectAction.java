//AmvAdsAttachSelectAction imports @1-4B59F515
...
//End AmvAdsAttachSelectAction imports

//AmvAdsAttachSelectAction class @1-FC7FE8D9
public class AmvAdsAttachSelectAction extends Action {

//End AmvAdsAttachSelectAction class

//AmvAdsAttachSelectAction: method perform @1-4D1628B7
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvAdsAttachSelectModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvAdsAttachSelectModel", page );
...
//End AmvAdsAttachSelectAction: method perform

//AmvAdsAttachSelectAction: call children actions @1-C43DF56A
...
//End AmvAdsAttachSelectAction: call children actions
...
//FILE_LIST Record: children actions @2-4685D5C4
...
//ListBoxAction @27-06DEF29A
        protected void readDOCUMENTO(com.codecharge.components.ListBox model) {
            ...
            command.setSql( "select distinct replace(nome,'.'||tipo,'.'||lower(tipo)) nome "
...
//AmvAdsAttachSelect Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvAdsAttachSelect Page: method validate

//AmvAdsAttachSelectAction Tail @1-FCB6E20C
}
//End AmvAdsAttachSelectAction Tail
