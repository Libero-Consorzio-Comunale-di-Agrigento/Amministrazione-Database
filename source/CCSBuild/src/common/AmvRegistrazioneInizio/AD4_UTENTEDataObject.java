//AD4_UTENTE DataSource @6-861B0D00
...
//loadDataBind @6-7ED69A32
        if ( record == null || record.isEmpty() ) {
            empty = true;
        } else {
            row.setSTATO_NASCITA(Utils.convertToLong(ds.parse(record.get("STATO_NASCITA"), row.getSTATO_NASCITAField())));
