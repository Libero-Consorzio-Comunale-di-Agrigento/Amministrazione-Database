...
//AmvRegistrazioneInizioAction: call children actions @1-BBC290FF
...
//AD4_UTENTE Record: children actions @6-ADDC4E5B
...
//AD4_UTENTE Record: bind @6-D97F1722
            public void bind(com.codecharge.components.Component model, AD4_UTENTERow row ) {
                ...
                if ( this.valid ) {
                    model.getControl("STATO_NASCITA").setValue(row.getSTATO_NASCITA());
                    model.getControl("REDIRECTION").setValue(row.getREDIRECTION());
                }
            }
//End AD4_UTENTE Record: bind

//AD4_UTENTE Record: getRowFieldByName @6-353DB524
...
//AD4_UTENTE Record: method validate @6-E6AEDFDB
        boolean validate() {
