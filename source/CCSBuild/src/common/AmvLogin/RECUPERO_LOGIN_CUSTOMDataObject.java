//RECUPERO_LOGIN_CUSTOM DataSource @17-F2C2DF4A
...
//class DataObject Header @17-FFEA32FF
public class RECUPERO_LOGIN_CUSTOMDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @17-19DD80E8
...
//properties of DataObject @17-8AE152B2
...
//load @17-35563D01
    boolean load() {
        ...
        command.setSql( "SELECT amvweb.get_preferenza('Messaggio Recupero Password','{Modulo}')||'<br/>' LOSTMSGCUSTOM "
                    + "FROM AD4_SERVIZI "
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( SELECT amvweb.get_preferenza('Messaggio Recupero Password','{Modulo}')||'<br/>' LOSTMSGCUSTOM FROM AD4_SERVIZI WHERE istanza = '{Istanza}' AND modulo = '{Modulo}' ) cnt " );
...
//getParameterByName @17-D3FA9408
