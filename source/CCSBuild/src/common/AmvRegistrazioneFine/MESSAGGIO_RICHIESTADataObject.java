...
//attributes of DataObject @7-DEC322C3
...
//properties of DataObject @7-078BACD5
...
//load @7-213D8CE5
    boolean load() {
        ...
        command.setSql( "SELECT AMV_UTENTE.GET_MESSAGGIO_RICHIESTA({MVRIC}) msg "
                    + " FROM DUAL" );
