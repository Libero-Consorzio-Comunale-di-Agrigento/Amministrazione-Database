...
public class LOGINRecordHandler implements RecordListener {
//End LOGINHandler Head

//BeforeShow Head @2-46046458
    public void beforeShow(Event e) {
//End BeforeShow Head

//Set values @2-D2D9E61C
        e.getRecord().getControl("ACTION").setValue(e.getPage().getRequest().getContextPath()+"/common/SecureLogin.jsp");
//End Set values
...
//LOGINHandler Tail @2-FCB6E20C
}
//End LOGINHandler Tail
