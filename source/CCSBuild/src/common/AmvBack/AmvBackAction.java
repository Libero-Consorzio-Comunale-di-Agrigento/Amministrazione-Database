//AmvBackAction imports @1-1247D393
...
//End AmvBackAction imports

//AmvBackAction class @1-F4BB4642
public class AmvBackAction extends Action {

//End AmvBackAction class

//AmvBackAction: method perform @1-55B0A1C4
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvBackModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvBackModel", page );
...
//End AmvBackAction: method perform

//AmvBackAction: call children actions @1-0C463DA0
        if (result == null) {
...
//End AmvBackAction: call children actions
...
//AmvBack Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvBack Page: method validate

//AmvBackAction Tail @1-FCB6E20C
}
//End AmvBackAction Tail
