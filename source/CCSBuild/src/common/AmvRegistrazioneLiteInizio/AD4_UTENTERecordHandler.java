//AD4_UTENTEHandler Head @6-116A609C
...
//Event BeforeUpdate Action JFC CCS Record Class caller DB @70-DC4394CF
/* ------------------------------------------- *
...
try{
    ...
    it.finmatica.jfc.ccs.AmvRegistrazioneLiteInizio istanza = new it.finmatica.jfc.ccs.AmvRegistrazioneLiteInizio(e,con);
    istanza.registraWeb();
