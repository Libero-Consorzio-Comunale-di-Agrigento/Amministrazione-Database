//AD4DirittoAccesso2Model imports @1-B7858E14
...
//End AD4DirittoAccesso2Model imports

//AD4DirittoAccesso2Model class head @1-FBC09C67
public class AD4DirittoAccesso2Model extends com.codecharge.components.Page {
    public AD4DirittoAccesso2Model() {
        this( new CCSLocale(), null );
    }

    public AD4DirittoAccesso2Model(CCSLocale locale) {
        this( locale, null );
    }

    public AD4DirittoAccesso2Model( CCSLocale locale, HttpServletResponse response ) {
//End AD4DirittoAccesso2Model class head

//page settings @1-74A7D98A
        super("AD4DirittoAccesso2", locale );
        setResponse(response);
        addPageListener(new AD4DirittoAccesso2PageHandler());
        {
            ...
            JS_REFRESH_SLAVES__165.addControlListener( new AD4DirittoAccesso2JS_REFRESH_SLAVESHandler());
            add( JS_REFRESH_SLAVES__165 );
        } // end page
//End page settings

//AD4_DIRITTI_ACCESSO1 record @38-7A2BBE7A
        ...
        */
        {
            ...
            AD4_DIRITTI_ACCESSO1.setReturnPage("AD4DirittoAccesso2" + Names.ACTION_SUFFIX);
...
//AD4DirittoAccesso2Model class tail @1-F5FC18C5
    }
}
//End AD4DirittoAccesso2Model class tail
