//AD4StampaVariazioniDiacAction imports @1-C1204AD0
...
//End AD4StampaVariazioniDiacAction imports

//AD4StampaVariazioniDiacAction class @1-A912AA8E
public class AD4StampaVariazioniDiacAction extends Action {

//End AD4StampaVariazioniDiacAction class

//AD4StampaVariazioniDiacAction: method perform @1-177EC1C3
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AD4StampaVariazioniDiacModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AD4StampaVariazioniDiacModel", page );
...
//End AD4StampaVariazioniDiacAction: method perform

//AD4StampaVariazioniDiacAction: call children actions @1-B290FDEE
...
//End AD4StampaVariazioniDiacAction: call children actions
...
//PARAMETRI Record: children actions @6-E1733E9A
...
//PARAMETRI Record: getRowFieldByName @6-06842549
...
//PARAMETRI Record: method validate @6-A6CD3469
        boolean validate() {
...
//AD4StampaVariazioniDiac Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AD4StampaVariazioniDiac Page: method validate

//AD4StampaVariazioniDiacAction Tail @1-FCB6E20C
}
//End AD4StampaVariazioniDiacAction Tail
