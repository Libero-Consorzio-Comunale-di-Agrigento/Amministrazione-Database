//Ad4DizionariAslComuneImpostaAction imports @1-115D6CC0
...
//AslComuneImposta Record: children actions @5-BD3175EF
...
//AslComuneImposta Record: bind @5-0133023D
...
//AslComuneImposta Record: getRowFieldByName @5-A32039C7
...
//AslComuneImposta Record: method insert body @5-34E65BDF
            if (!model.isAllowInsert()) return;
            boolean isErrors = false;
            AslComuneImpostaDataObject ds = new AslComuneImpostaDataObject(page);
            ds.setComponent( model );
            ...
            try {
                ds.setUrlIN_REGIONE_ASL( page.getHttpGetParams().getParameter("IN_REGIONE_ASL"), null );
            } catch ( java.text.ParseException pe ) {
                model.addError( "Invalid parameter 'IN_REGIONE_ASL'" );
            } catch ( NumberFormatException nfe ) {
                model.addError( "Invalid parameter 'IN_REGIONE_ASL'" );
            }
            try {
...
//AslComuneImposta Record: method delete body @5-350AAA4B
            if (!model.isAllowDelete()) return;
            boolean isErrors = false;
            AslComuneImpostaDataObject ds = new AslComuneImpostaDataObject(page);
            ds.setComponent( model );
...
//AslComuneImposta Record: method validate @5-DA08DEC2
        boolean validate() {
