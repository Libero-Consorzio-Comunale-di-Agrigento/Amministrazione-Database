//AD4_PROGETTIHandler Head @23-E8380548
...
public class AD4_PROGETTIRecordHandler implements RecordListener {
//End AD4_PROGETTIHandler Head

//BeforeShow Head @23-46046458
    public void beforeShow(Event e) {
//End BeforeShow Head

//Set values @23-5BF849DE
        e.getRecord().getLink("Caratteristiche").getParameter("TIPO_ACCESSO").setValue(( "P" ));
//End Set values

//Event BeforeShow Action Save Control Value @52-969891AC
        SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4PROGETTO", ((com.codecharge.components.Hidden) ((com.codecharge.components.Record) (e.getPage().getChild( "AD4_PROGETTI" ))).getChild( "PROGETTO_ORIG" )).getValue() );
...
//AD4_PROGETTIHandler Tail @23-FCB6E20C
}
//End AD4_PROGETTIHandler Tail
