//AD4GruppiTreeHandler imports @1-68DAC2EC
...
//End AD4GruppiTreeHandler imports

//AD4GruppiTreeHandler Head @1-608C6CE1
public class AD4GruppiTreePageHandler implements PageListener {
//End AD4GruppiTreeHandler Head
...
//Event BeforeShow Action Set BackPage Value from Session URLs @20-EA258D47
 ...
 * -------------------------- */
 SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4JOBRIGSO","0");
 SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4JOBLDAPFROMSO","0");
...
//AD4GruppiTreeHandler Tail @1-FCB6E20C
}
//End AD4GruppiTreeHandler Tail
