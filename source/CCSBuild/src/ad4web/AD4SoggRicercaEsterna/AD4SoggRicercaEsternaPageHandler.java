//AD4SoggRicercaEsternaHandler imports @1-2BAD11B6
...
//End AD4SoggRicercaEsternaHandler imports

//AD4SoggRicercaEsternaHandler Head @1-5B92394F
public class AD4SoggRicercaEsternaPageHandler implements PageListener {
//End AD4SoggRicercaEsternaHandler Head

//AfterInitialize Head @1-89E84600
    public void afterInitialize(Event e) {
//End AfterInitialize Head

//Event AfterInitialize Action SetVarSessionValue @6-26EBAE6D
    SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4PaginaSoggetto", "AD4SoggettoEsterna.do");
//End Event AfterInitialize Action SetVarSessionValue
...
//Event BeforeShow Action Set BackPage Value from Session URLs @2-EA258D47
...
//AD4SoggRicercaEsternaHandler Tail @1-FCB6E20C
}
//End AD4SoggRicercaEsternaHandler Tail
