...
//class DataObject Header @11-62DEA11A
public class eventiDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @11-77074452
...
//properties of DataObject @11-165B699B
...
//loadDataBind @11-7CFBE691
        if ( record == null || record.isEmpty() ) {
            empty = true;
        } else {
            row.setDUMMY(Utils.convertToString(ds.parse(record.get("DUMMY"), row.getDUMMYField())));
        }
//End loadDataBind
...
//update @11-E9A68160
        boolean update() {
            ...
            command.setSql( "{ ? = call ACCESSO.ELIMINA_ARCHIVIATI }" );
