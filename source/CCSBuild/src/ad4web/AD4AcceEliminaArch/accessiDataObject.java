//accessi DataSource @11-D79F25A3
...
//End accessi DataSource

//class DataObject Header @11-2D376035
public class accessiDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @11-46E05E90
    

    private accessiRow row = new accessiRow();

//End attributes of DataObject

//properties of DataObject @11-E663EB2E

    public accessiRow getRow() {
        return row;
    }

    public void setRow( accessiRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @11-5CAAE678
    public accessiDataObject(Page page) {
        super(page);
        addRecordDataObjectListener( new accessiDataObjectHandler() );
    }
//End constructor
