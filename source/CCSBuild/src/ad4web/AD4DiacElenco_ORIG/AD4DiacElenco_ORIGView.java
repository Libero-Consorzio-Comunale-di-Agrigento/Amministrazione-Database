//AD4DiacElenco_ORIGView imports @1-EDE6C3D2
...
//End AD4DiacElenco_ORIGView imports

//AD4DiacElenco_ORIGView class @1-59E92A00
public class AD4DiacElenco_ORIGView extends View {
//End AD4DiacElenco_ORIGView class

//AD4DiacElenco_ORIGView: method show @1-AB553063
    public String show( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        this.page = (AD4DiacElenco_ORIGModel) req.getAttribute( "AD4DiacElenco_ORIGModel" );
        if (this.page == null) return "";
        String enc = (req.getAttribute(page.getName()+"Parent")!=null) ? ((com.codecharge.components.Page) req.getAttribute(page.getName()+"Parent")).getCharacterEncoding() : null;
        page.setCharacterEncoding("windows-1252");
        this.tmplPath = "/ad4web/AD4DiacElenco_ORIG.html";
...
//End AD4DiacElenco_ORIGView: method show
...
//AD4DiacElenco_ORIGView Tail @1-FCB6E20C
}
//End AD4DiacElenco_ORIGView Tail
