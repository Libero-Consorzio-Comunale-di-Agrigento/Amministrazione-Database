//AD4DiacElenco_ORIGModel imports @1-24A2EB09
...
//End AD4DiacElenco_ORIGModel imports

//AD4DiacElenco_ORIGModel class head @1-1D88A300
public class AD4DiacElenco_ORIGModel extends com.codecharge.components.Page {
    public AD4DiacElenco_ORIGModel() {
        this( new CCSLocale(), null );
    }

    public AD4DiacElenco_ORIGModel(CCSLocale locale) {
        this( locale, null );
    }

    public AD4DiacElenco_ORIGModel( CCSLocale locale, HttpServletResponse response ) {
//End AD4DiacElenco_ORIGModel class head

//page settings @1-6D15ECF1
        super("AD4DiacElenco_ORIG", locale );
        setResponse(response);
        addPageListener(new AD4DiacElenco_ORIGPageHandler());
        {
...
//AD4DiacElenco_ORIGModel class tail @1-F5FC18C5
    }
}
//End AD4DiacElenco_ORIGModel class tail
