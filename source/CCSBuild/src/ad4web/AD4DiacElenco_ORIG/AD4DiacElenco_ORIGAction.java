//AD4DiacElenco_ORIGAction imports @1-E708F656
...
//End AD4DiacElenco_ORIGAction imports

//AD4DiacElenco_ORIGAction class @1-F89FCF48
public class AD4DiacElenco_ORIGAction extends Action {

//End AD4DiacElenco_ORIGAction class

//AD4DiacElenco_ORIGAction: method perform @1-79072708
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AD4DiacElenco_ORIGModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AD4DiacElenco_ORIGModel", page );
...
//End AD4DiacElenco_ORIGAction: method perform

//AD4DiacElenco_ORIGAction: call children actions @1-82C31BDB
...
//End AD4DiacElenco_ORIGAction: call children actions
...
//AD4DiacElenco_ORIG Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AD4DiacElenco_ORIG Page: method validate

//AD4DiacElenco_ORIGAction Tail @1-FCB6E20C
}
//End AD4DiacElenco_ORIGAction Tail
