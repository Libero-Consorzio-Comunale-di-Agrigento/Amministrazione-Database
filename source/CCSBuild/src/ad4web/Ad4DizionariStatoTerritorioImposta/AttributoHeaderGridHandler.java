//AttributoHeaderGridHandler @2-40E28DBF
...
//Set values for static controls @2-61E8AF5A
        e.getGrid().getControl("Indietro").setValue("Indietro");
        e.getGrid().getLink("Indietro").getParameter("MVPG").setValue(( "Ad4DizionariStatiTerritoriElenco" ));
