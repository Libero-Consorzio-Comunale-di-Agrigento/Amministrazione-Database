//AD4Ruoli_VSearch DataSource @6-8004FB53
...
//End AD4Ruoli_VSearch DataSource

//class DataObject Header @6-C849CA17
public class AD4Ruoli_VSearchDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @6-3A84EED7
    

    TextField urlS_DESCRIZIONE = new TextField(null, null);
    

    private AD4Ruoli_VSearchRow row = new AD4Ruoli_VSearchRow();

//End attributes of DataObject

//properties of DataObject @6-57B01668
    ...
    public AD4Ruoli_VSearchRow getRow() {
        return row;
    }

    public void setRow( AD4Ruoli_VSearchRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @6-8E507CB8
    public AD4Ruoli_VSearchDataObject(Page page) {
        super(page);
    }
//End constructor
