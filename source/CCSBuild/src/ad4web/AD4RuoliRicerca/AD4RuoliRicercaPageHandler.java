//AD4RuoliRicercaHandler imports @1-6031F9E5
...
//End AD4RuoliRicercaHandler imports

//AD4RuoliRicercaHandler Head @1-A7498921
public class AD4RuoliRicercaPageHandler implements PageListener {
//End AD4RuoliRicercaHandler Head
...
//DEL   * -------------------------- */
//DEL   CCSLocale mioLoc = new CCSLocale(new Locale("it","IT")); 
//DEL  e.getPage().setCCSLocale(mioLoc);
...
//Event BeforeShow Action Set BackPage Value from Session URLs @391-EA258D47
...
//AD4RuoliRicercaHandler Tail @1-FCB6E20C
}
//End AD4RuoliRicercaHandler Tail
