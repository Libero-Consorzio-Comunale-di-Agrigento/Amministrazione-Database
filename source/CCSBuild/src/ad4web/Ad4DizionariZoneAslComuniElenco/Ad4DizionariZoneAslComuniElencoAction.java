//Ad4DizionariZoneAslComuniElencoAction imports @1-F0E0BEDB
...
//End Ad4DizionariZoneAslComuniElencoAction imports

//Ad4DizionariZoneAslComuniElencoAction class @1-870E7E84
public class Ad4DizionariZoneAslComuniElencoAction extends Action {

//End Ad4DizionariZoneAslComuniElencoAction class

//Ad4DizionariZoneAslComuniElencoAction: method perform @1-1FA23392
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new Ad4DizionariZoneAslComuniElencoModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "Ad4DizionariZoneAslComuniElencoModel", page );
...
//End Ad4DizionariZoneAslComuniElencoAction: method perform

//Ad4DizionariZoneAslComuniElencoAction: call children actions @1-8DE7DCCE
        if (result == null) {
...
//End Ad4DizionariZoneAslComuniElencoAction: call children actions
...
//Titolo Grid: set where parameters @40-E88E7454
...
//ComuniElenco Grid: set where parameters @8-6370CD49
            ds.setUrlS_COMUNE( page.getHttpGetParams().getParameter("s_COMUNE") );
            ds.setUrlID_ZONA_ASL( page.getHttpGetParams().getParameter("ID_ZONA_ASL") );
...
//ComuniElenco Grid: method bind @8-22350911
...
//ComuniElenco Directory: getRowFieldByName @8-CED61521
...
//Ad4DizionariZoneAslComuniElenco Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End Ad4DizionariZoneAslComuniElenco Page: method validate

//Ad4DizionariZoneAslComuniElencoAction Tail @1-FCB6E20C
}
//End Ad4DizionariZoneAslComuniElencoAction Tail
