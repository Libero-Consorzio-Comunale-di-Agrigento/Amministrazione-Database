//StatiFiltro DataSource @3-BE279D1B
...
//End StatiFiltro DataSource

//class DataObject Header @3-4A8771C3
public class StatiFiltroDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @3-B7D8D9FC
    

    TextField urlS_STATO = new TextField(null, null);
    

    private StatiFiltroRow row = new StatiFiltroRow();

//End attributes of DataObject

//properties of DataObject @3-3B923DF2
    ...
    public StatiFiltroRow getRow() {
        return row;
    }

    public void setRow( StatiFiltroRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @3-E3BE682D
    public StatiFiltroDataObject(Page page) {
        super(page);
    }
//End constructor
...
//load @3-ED94CE31
    boolean load() {
        ...
        command.setSql( "select ad4_ccs.filter_search('{s_STATO}')   filter_search "
                    + "      ,'{s_STATO}'                          s_stato "
                    + "  from dual" );
...
//loadDataBind @3-C262F779
        if ( record == null || record.isEmpty() ) {
            empty = true;
        } else {
            row.setFILTER_SEARCH(Utils.convertToString(ds.parse(record.get("FILTER_SEARCH"), row.getFILTER_SEARCHField())));
            row.setS_STATO(Utils.convertToString(ds.parse(record.get("S_STATO"), row.getS_STATOField())));
        }
//End loadDataBind
