//AD4UtenteHandler imports @1-B4671776
...
//End AD4UtenteHandler imports

//AD4UtenteHandler Head @1-1E415A37
public class AD4UtentePageHandler implements PageListener {
//End AD4UtenteHandler Head
...
//Event BeforeShow Action Set BackPage Value from Session URLs @112-BBE4AFE4
...
//Event BeforeShow Action Custom Code @129-44795B7A
/* -------------------------- *
 *  write your own code here  *
 * -------------------------- */
SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("Ad4PwdGenerata", "");
...
//AD4UtenteHandler Tail @1-FCB6E20C
}
//End AD4UtenteHandler Tail
