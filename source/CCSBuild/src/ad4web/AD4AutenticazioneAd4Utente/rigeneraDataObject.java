//rigenera DataSource @11-2EAD8381
...
//End rigenera DataSource

//class DataObject Header @11-A0EA541D
public class rigeneraDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @11-0A54CEB8
    

    TextField urlP_UTENTE = new TextField(null, null);
    

    private rigeneraRow row = new rigeneraRow();

//End attributes of DataObject

//properties of DataObject @11-FB3A00CD
    ...
    public rigeneraRow getRow() {
        return row;
    }

    public void setRow( rigeneraRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @11-5EC80A1B
    public rigeneraDataObject(Page page) {
        super(page);
        addRecordDataObjectListener( new rigeneraDataObjectHandler() );
    }
//End constructor
