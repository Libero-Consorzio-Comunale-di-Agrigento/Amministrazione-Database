//ad4Authenticate DataSource @11-2EAD8381
...
//End ad4Authenticate DataSource

//class DataObject Header @11-8FAABAC6
public class ad4AuthenticateDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @11-0C443D4E
    

    TextField urlP_UTENTE = new TextField(null, null);
    

    private ad4AuthenticateRow row = new ad4AuthenticateRow();

//End attributes of DataObject

//properties of DataObject @11-8F39E485
    ...
    public ad4AuthenticateRow getRow() {
        return row;
    }

    public void setRow( ad4AuthenticateRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @11-3C147C44
    public ad4AuthenticateDataObject(Page page) {
        super(page);
        addRecordDataObjectListener( new ad4AuthenticateDataObjectHandler() );
    }
//End constructor
...
//update @11-7DCCC363
        boolean update() {
            ...
            command.setSql( "{call UTENTE.REMOVE_LDAP_AUTHENTICATION(?)}" );
...
//getParameterByName @11-88853512
