//AttributoHeaderGridHandler @2-2BE982B7
...
//Set values for static controls @2-F28DE837
        e.getGrid().getControl("Indietro").setValue("Indietro");
        e.getGrid().getLink("Indietro").getParameter("MVPG").setValue(( "Ad4DizionariProvinceElenco" ));
