//AD4_SOGGETTODataObjectHandler head @6-0F5B5960
...
public class AD4_SOGGETTODataObjectHandler implements RecordDataObjectListener {
//End AD4_SOGGETTODataObjectHandler head
...
//Event AfterExecuteInsert Action BeforeSetVarSessionFromSPParm @184-C405D236
    String sessionVar;
    int index;
    JDBCConnection ds = ((SPCommand)e.getCommand()).getJdbcConnection();
//End Event AfterExecuteInsert Action BeforeSetVarSessionFromSPParm

//Event AfterExecuteInsert Action SetVarSessionFromSPParm @185-A9C1055F
    sessionVar = "AD4SOGG";
...
//End Event AfterExecuteInsert Action SetVarSessionFromSPParm
...
//AD4_SOGGETTODataObjectHandler Tail @6-FCB6E20C
}
//End AD4_SOGGETTODataObjectHandler Tail
