//AD4SoggettoInclusaHandler imports @1-CA7ED73D
...
//End AD4SoggettoInclusaHandler imports

//AD4SoggettoInclusaHandler Head @1-62B80A33
public class AD4SoggettoInclusaPageHandler implements PageListener {
//End AD4SoggettoInclusaHandler Head
...
//Event BeforeShow Action Set BackPage Value from Session URLs @183-7FA01B74
...
//Event BeforeShow Action SetVarSessionValue @189-C6465EE7
    SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4SOGG", "");
...
//AD4SoggettoInclusaHandler Tail @1-FCB6E20C
}
//End AD4SoggettoInclusaHandler Tail
