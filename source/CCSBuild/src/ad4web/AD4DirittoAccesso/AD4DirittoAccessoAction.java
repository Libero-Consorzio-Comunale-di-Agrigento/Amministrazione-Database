//AD4DirittoAccessoAction imports @1-97036115
...
//End AD4DirittoAccessoAction imports

//AD4DirittoAccessoAction class @1-852021DE
public class AD4DirittoAccessoAction extends Action {

//End AD4DirittoAccessoAction class

//AD4DirittoAccessoAction: method perform @1-CC0C32DA
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AD4DirittoAccessoModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AD4DirittoAccessoModel", page );
...
//End AD4DirittoAccessoAction: method perform

//AD4DirittoAccessoAction: call children actions @1-2FD5C0D3
...
//End AD4DirittoAccessoAction: call children actions
...
//AD4DirittoAccesso Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AD4DirittoAccesso Page: method validate

//AD4DirittoAccessoAction Tail @1-FCB6E20C
}
//End AD4DirittoAccessoAction Tail
