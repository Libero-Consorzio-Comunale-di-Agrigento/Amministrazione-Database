//ComuniSearch DataSource @2-5322B5D9
...
//End ComuniSearch DataSource

//class DataObject Header @2-E97E4934
public class ComuniSearchDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @2-E661F21D
    ...
    private ComuniSearchRow row = new ComuniSearchRow();

//End attributes of DataObject

//properties of DataObject @2-D4EFFA36
    ...
    public ComuniSearchRow getRow() {
        return row;
    }

    public void setRow( ComuniSearchRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @2-4C9B5CAE
    public ComuniSearchDataObject(Page page) {
        super(page);
    }
//End constructor
...
//load @2-DCAC0F7B
    boolean load() {
        ...
        command.setSql( "select ad4_ccs.filter_search('{s_COMUNE}'||'{s_PROVINCIA_SIGLA}') filter_search "
                    + "  from dual" );
