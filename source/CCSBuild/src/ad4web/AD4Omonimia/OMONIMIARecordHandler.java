//OMONIMIAHandler Head @6-11C62FFF
...
public class OMONIMIARecordHandler implements RecordListener {
//End OMONIMIAHandler Head

//BeforeShow Head @6-46046458
    public void beforeShow(Event e) {
//End BeforeShow Head

//Set values @6-72AA7E35
        e.getRecord().getControl("s_primario").setValue(0);
        if (! e.getRecord().isEditMode()) {
            e.getRecord().getControl("s_primario").setDefaultValue(0);
            e.getRecord().getControl("s_ignorare").setDefaultValue(0);
        }
//End Set values
...
//OMONIMIAHandler Tail @6-FCB6E20C
}
//End OMONIMIAHandler Tail
