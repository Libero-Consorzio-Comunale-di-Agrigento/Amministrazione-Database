//AD4_ENTIHandler Head @6-CF53EA09
...
public class AD4_ENTIRecordHandler implements RecordListener {
//End AD4_ENTIHandler Head

//BeforeShow Head @6-46046458
    public void beforeShow(Event e) {
//End BeforeShow Head

//Set values @6-A2DB6F01
        e.getRecord().getLink("SVUOTA_REG_ANAGRAFICA").getParameter("SOGGETTO").setValue(( -1 ));
//End Set values

//Event BeforeShow Action Save Control Value @117-A1F10828
        SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4ENTE", ((com.codecharge.components.Label) ((com.codecharge.components.Record) (e.getPage().getChild( "AD4_ENTI" ))).getChild( "ENTE" )).getValue() );
...
//AD4_ENTIHandler Tail @6-FCB6E20C
}
//End AD4_ENTIHandler Tail
