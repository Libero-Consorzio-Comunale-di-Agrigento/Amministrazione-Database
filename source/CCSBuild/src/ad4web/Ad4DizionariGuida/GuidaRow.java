...
//GuidaRow: declare fiels @2-0CE361CC
    private TextField FOLDER1 = new TextField("FOLDER1", "FOLDER1");
    private TextField FOLDER2 = new TextField("FOLDER2", "FOLDER2");
    private TextField FOLDER3 = new TextField("FOLDER3", "FOLDER3");
    private TextField FOLDER4 = new TextField("FOLDER4", "FOLDER4");
    private TextField FOLDER5 = new TextField("FOLDER5", "FOLDER5");
    private TextField FOLDER6 = new TextField("FOLDER6", "FOLDER6");
...
//GuidaRow: method(s) of FOLDER3 @5-6A3B6ECF
    public TextField getFOLDER3Field() {
        return FOLDER3;
    }

    public String getFOLDER3() {
        return FOLDER3.getValue();
    }

    public void setFOLDER3(String value) {
        this.FOLDER3.setValue(value);
    }
//End GuidaRow: method(s) of FOLDER3

//GuidaRow: method(s) of FOLDER4 @6-00C8C481
    public TextField getFOLDER4Field() {
        return FOLDER4;
    }

    public String getFOLDER4() {
        return FOLDER4.getValue();
    }

    public void setFOLDER4(String value) {
        this.FOLDER4.setValue(value);
    }
//End GuidaRow: method(s) of FOLDER4
...
//GuidaRow: method(s) of FOLDER6 @10-6F4F6F1E
    public TextField getFOLDER6Field() {
        return FOLDER6;
    }

    public String getFOLDER6() {
        return FOLDER6.getValue();
    }

    public void setFOLDER6(String value) {
        this.FOLDER6.setValue(value);
    }
//End GuidaRow: method(s) of FOLDER6
