//AD4SoggModIndirizzoAction imports @1-2C3A597D
...
//End AD4SoggModIndirizzoAction imports

//AD4SoggModIndirizzoAction class @1-4F98D883
public class AD4SoggModIndirizzoAction extends Action {

//End AD4SoggModIndirizzoAction class

//AD4SoggModIndirizzoAction: method perform @1-B34EDD6E
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AD4SoggModIndirizzoModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AD4SoggModIndirizzoModel", page );
...
//End AD4SoggModIndirizzoAction: method perform

//AD4SoggModIndirizzoAction: call children actions @1-2CA6F6A9
        if (result == null) {
...
//End AD4SoggModIndirizzoAction: call children actions
...
//AD4_UTENTI Record: method perform @2-0B12456A
        String perform(com.codecharge.components.Record model) {
            //e = new ActionEvent( model, page );
            this.model = model;
            if ( ! model.isVisible() ) { return null;}
            StringBuffer performReturnPage = new StringBuffer( "AD4SoggModIndirizzo" + Names.ACTION_SUFFIX );
            performReturnPage.append( "?" + page.getHttpGetParams().toString( model.getExcludeParams() ) );
            page.setRedirectString( performReturnPage.toString() );
//End AD4_UTENTI Record: method perform

//AD4_UTENTI Record: children actions @2-443B2FC0
...
//Button_Update Button @6-4A76C258
        void Button_UpdateAction() {
            ...
            page.setRedirectString( "AD4SoggModIndirizzo" + Names.ACTION_SUFFIX + "?" + page.getHttpGetParams().toString( excludeParams ) );
            buttonModel.fireOnClickEvent();
        }
//End Button_Update Button

//Button_Cancel Button @7-D6B0E175
...
//AD4_UTENTI Record: getRowFieldByName @2-84650F33
...
//AD4_UTENTI Record: method validate @2-BB6C6242
        boolean validate() {
...
//AD4SoggModIndirizzo Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AD4SoggModIndirizzo Page: method validate

//AD4SoggModIndirizzoAction Tail @1-FCB6E20C
}
//End AD4SoggModIndirizzoAction Tail
