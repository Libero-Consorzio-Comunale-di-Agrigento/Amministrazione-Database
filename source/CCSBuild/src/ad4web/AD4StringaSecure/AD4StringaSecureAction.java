//AD4StringaSecureAction imports @1-40A4930B
...
//End AD4StringaSecureAction imports

//AD4StringaSecureAction class @1-52FCC69B
public class AD4StringaSecureAction extends Action {

//End AD4StringaSecureAction class

//AD4StringaSecureAction: method perform @1-EB2CF684
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AD4StringaSecureModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AD4StringaSecureModel", page );
...
//End AD4StringaSecureAction: method perform

//AD4StringaSecureAction: call children actions @1-479D3D0C
...
//End AD4StringaSecureAction: call children actions
...
//AD4StringaSecure Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AD4StringaSecure Page: method validate

//AD4StringaSecureAction Tail @1-FCB6E20C
}
//End AD4StringaSecureAction Tail
