//AD4EventoHandler imports @1-7302F87D
...
//End AD4EventoHandler imports

//AD4EventoHandler Head @1-F9BCC64F
public class AD4EventoPageHandler implements PageListener {
//End AD4EventoHandler Head

//AfterInitialize Head @1-89E84600
    public void afterInitialize(Event e) {
//End AfterInitialize Head

//DEL   SessionStorage.getInstance(req).setAttribute("AD4ACCERIPR",0);
...
//Event BeforeShow Action Set BackPage Value from Session URLs @156-7FA01B74
...
//Event BeforeShow Action SetVarSessionValue @192-56B3BF5A
    SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4ACCERIPR", "0");
//End Event BeforeShow Action SetVarSessionValue
...
//AD4EventoHandler Tail @1-FCB6E20C
}
//End AD4EventoHandler Tail
