//AD4Enti_VSearchHandler Head @6-E639EF58
...
public class AD4Enti_VSearchRecordHandler implements RecordListener {
//End AD4Enti_VSearchHandler Head

//BeforeShow Head @6-46046458
    public void beforeShow(Event e) {
//End BeforeShow Head

//Set values @6-DC1F7453
        e.getRecord().getLink("Nuovo").getParameter("SE_NUOVO").setValue(( "Y" ));
        e.getRecord().getLink("Nuovo").getParameter("MVVC").setValue(( "AD4ENTIA" ));
//End Set values
...
//AD4Enti_VSearchHandler Tail @6-FCB6E20C
}
//End AD4Enti_VSearchHandler Tail
