//AD4DiacElencoSTEModel imports @1-B101B6DD
...
//page settings @1-8DFD3485
        ...
        addPageListener(new AD4DiacElencoSTEPageHandler());
        {
            ...
            add( Left__3 );
            com.codecharge.components.IncludePage Guida__169 = new com.codecharge.components.IncludePage("Guida", this );
            Guida__169.setVisible( true );
            add( Guida__169 );
