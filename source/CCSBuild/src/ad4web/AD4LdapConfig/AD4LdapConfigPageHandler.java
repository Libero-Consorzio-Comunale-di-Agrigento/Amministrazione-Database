//AD4LdapConfigHandler imports @1-3B235E59
...
//End AD4LdapConfigHandler imports

//AD4LdapConfigHandler Head @1-6F51889D
public class AD4LdapConfigPageHandler implements PageListener {
//End AD4LdapConfigHandler Head
...
//Event BeforeShow Action Set BackPage Value from Session URLs @76-EA258D47
...
//Event BeforeShow Action Custom Code @135-44795B7A
/* -------------------------- *
 *  write your own code here  *
 * -------------------------- */
 SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4LDAPCA","");
...
//AD4LdapConfigHandler Tail @1-FCB6E20C
}
//End AD4LdapConfigHandler Tail
