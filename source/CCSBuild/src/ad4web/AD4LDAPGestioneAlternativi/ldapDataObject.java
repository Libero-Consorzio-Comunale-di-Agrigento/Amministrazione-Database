...
//class DataObject Header @11-93E47895
public class ldapDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @11-47D06E71
    

    TextField urlChiave = new TextField(null, null);
    

    private ldapRow row = new ldapRow();

//End attributes of DataObject

//properties of DataObject @11-DF260086
    ...
    public ldapRow getRow() {
        return row;
    }

    public void setRow( ldapRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @11-23A79CB0
    public ldapDataObject(Page page) {
        super(page);
        addRecordDataObjectListener( new ldapDataObjectHandler() );
    }
//End constructor
...
//update @11-D8E3BFA8
        boolean update() {
            ...
            command.setSql( "{ ? = call LDAP_UTILITY.CREA_SERVER_ALTERNATIVO }" );
...
//delete @11-443C27F5
        boolean delete() {
            ...
            command.setSql( "{ call REGISTRO_UTILITY.ELIMINA_CHIAVE ( ? ) }" );
            if ( StringUtils.isEmpty( (String) urlChiave.getObjectValue() ) ) urlChiave.setValue( "" );
            command.addParameter( "IN_CHIAVE", urlChiave, java.sql.Types.CHAR, 0, SPParameter.INPUT_PARAMETER );
...
//getParameterByName @11-8C88F508
