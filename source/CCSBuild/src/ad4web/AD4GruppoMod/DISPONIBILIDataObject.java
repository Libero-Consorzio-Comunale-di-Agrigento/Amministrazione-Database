//DISPONIBILI DataSource @52-86B84BDC
...
//attributes of DataObject @52-B8F192F6
...
//properties of DataObject @52-2D2EBE00
...
//constructor @52-7A895D2A
    public DISPONIBILIDataObject(Page page) {
        super(page);
        addRecordDataObjectListener( new DISPONIBILIDataObjectHandler() );
    }
//End constructor
...
//delete @52-F7BCB234
        boolean delete() {
            ...
            command.setSql( "{call AD4WEB.UTGR_INSERT(?,?,?)}" );
            if ( StringUtils.isEmpty( (String) postUTENTE_D.getObjectValue() ) ) postUTENTE_D.setValue( "" );
            command.addParameter( "P_UTENTE", postUTENTE_D, java.sql.Types.CHAR, 0, SPParameter.INPUT_PARAMETER );
            if ( StringUtils.isEmpty( (String) urlGRUPPO.getObjectValue() ) ) urlGRUPPO.setValue( "" );
            command.addParameter( "P_GRUPPO", urlGRUPPO, java.sql.Types.CHAR, 0, SPParameter.INPUT_PARAMETER );
            if ( StringUtils.isEmpty( (String) sesUtente.getObjectValue() ) ) sesUtente.setValue( "" );
            command.addParameter( "P_UTENTE_MOD", sesUtente, java.sql.Types.VARCHAR, 0, SPParameter.INPUT_PARAMETER );
...
//getParameterByName @52-CC20504D
