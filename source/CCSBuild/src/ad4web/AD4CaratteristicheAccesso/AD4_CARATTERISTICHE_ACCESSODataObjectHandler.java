//AD4_CARATTERISTICHE_ACCESSODataObjectHandler head @38-5D39C790
...
public class AD4_CARATTERISTICHE_ACCESSODataObjectHandler implements RecordDataObjectListener {
//End AD4_CARATTERISTICHE_ACCESSODataObjectHandler head
...
//Event AfterExecuteUpdate Action SetVarSessionValue @256-8B0DD5FA
    SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4BPCOPIA", "");
//End Event AfterExecuteUpdate Action SetVarSessionValue

//Event AfterExecuteUpdate Action AD4RefreshSlaves @257-2B13205D
...
//Event AfterExecuteDelete Action Copy Session Variable @258-5B3824F1
SessionStorage.getInstance(e.getPage().getRequest()).setAttribute("AD4BPCOPIA", (String) SessionStorage.getInstance(e.getPage().getRequest()).getAttribute("AD4BP") );
//End Event AfterExecuteDelete Action Copy Session Variable

//Event AfterExecuteDelete Action AD4RefreshSlaves @259-2B13205D
if(!e.getRecord().hasErrors()){
    String retValue = "";
    String istanza = (String)SessionStorage.getInstance(e.getPage().getRequest()).getAttribute("Istanza");
    JDBCConnection conn = JDBCConnectionFactory.getJDBCConnection("cn");
...
//AD4_CARATTERISTICHE_ACCESSODataObjectHandler Tail @38-FCB6E20C
}
//End AD4_CARATTERISTICHE_ACCESSODataObjectHandler Tail
