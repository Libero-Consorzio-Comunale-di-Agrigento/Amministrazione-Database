//AD4CaratteristicheAccessoModel imports @1-C843E631
...
//End AD4CaratteristicheAccessoModel imports

//AD4CaratteristicheAccessoModel class head @1-DFF227B5
public class AD4CaratteristicheAccessoModel extends com.codecharge.components.Page {
    public AD4CaratteristicheAccessoModel() {
        this( new CCSLocale(), null );
    }

    public AD4CaratteristicheAccessoModel(CCSLocale locale) {
        this( locale, null );
    }

    public AD4CaratteristicheAccessoModel( CCSLocale locale, HttpServletResponse response ) {
//End AD4CaratteristicheAccessoModel class head

//page settings @1-E6E0F9DD
        super("AD4CaratteristicheAccesso", locale );
        setResponse(response);
        addPageListener(new AD4CaratteristicheAccessoPageHandler());
        {
            ...
            JS_REFRESH_SLAVES__247.addControlListener( new AD4CaratteristicheAccessoJS_REFRESH_SLAVESHandler());
            add( JS_REFRESH_SLAVES__247 );
        } // end page
//End page settings

//AD4_CARATTERISTICHE_ACCESSO record @38-E17BD48C
        ...
        */
        {
            ...
            AD4_CARATTERISTICHE_ACCESSO.setReturnPage("AD4CaratteristicheAccesso" + Names.ACTION_SUFFIX);
            ...
            ACCESSO__206.addValidateHandler( new RequiredHandler( "Il valore nel campo ACCESSO è richiesto." ) );
            ...
            com.codecharge.components.TextBox GG_PRIMA_RIUTILIZZO_PWD__260 = new com.codecharge.components.TextBox("GG_PRIMA_RIUTILIZZO_PWD", "GG_PRIMA_RIUTILIZZO_PWD", this );
            GG_PRIMA_RIUTILIZZO_PWD__260.setType( com.codecharge.components.ControlType.INTEGER );
            GG_PRIMA_RIUTILIZZO_PWD__260.setHtmlEncode( true );
            AD4_CARATTERISTICHE_ACCESSO.add( GG_PRIMA_RIUTILIZZO_PWD__260 );

            com.codecharge.components.Hidden GG_PRIMA_RIUTILIZZO_PWD_OLD__261 = new com.codecharge.components.Hidden("GG_PRIMA_RIUTILIZZO_PWD_OLD", "GG_PRIMA_RIUTILIZZO_PWD_OLD", this );
            GG_PRIMA_RIUTILIZZO_PWD_OLD__261.setType( com.codecharge.components.ControlType.INTEGER );
            GG_PRIMA_RIUTILIZZO_PWD_OLD__261.setHtmlEncode( true );
            AD4_CARATTERISTICHE_ACCESSO.add( GG_PRIMA_RIUTILIZZO_PWD_OLD__261 );
...
//AD4CaratteristicheAccessoModel class tail @1-F5FC18C5
    }
}
//End AD4CaratteristicheAccessoModel class tail
