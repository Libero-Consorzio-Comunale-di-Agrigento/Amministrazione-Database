//AD4CaratteristicheAccessoAction imports @1-3496D9B5
...
//End AD4CaratteristicheAccessoAction imports

//AD4CaratteristicheAccessoAction class @1-C974FC38
public class AD4CaratteristicheAccessoAction extends Action {

//End AD4CaratteristicheAccessoAction class

//AD4CaratteristicheAccessoAction: method perform @1-AC51FB84
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AD4CaratteristicheAccessoModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AD4CaratteristicheAccessoModel", page );
...
//End AD4CaratteristicheAccessoAction: method perform

//AD4CaratteristicheAccessoAction: call children actions @1-D2B3291B
...
//End AD4CaratteristicheAccessoAction: call children actions
...
//AD4_CARATTERISTICHE_ACCESSO Record: bind @38-24E617F1
            public void bind(com.codecharge.components.Component model, AD4_CARATTERISTICHE_ACCESSORow row ) {
                ...
                if ( this.valid ) {
                    ...
                    model.getControl("GG_PRIMA_RIUTILIZZO_PWD").setValue(row.getGG_PRIMA_RIUTILIZZO_PWD());
                    model.getControl("GG_PRIMA_RIUTILIZZO_PWD_OLD").setValue(row.getGG_PRIMA_RIUTILIZZO_PWD_OLD());
...
//AD4_CARATTERISTICHE_ACCESSO Record: getRowFieldByName @38-7D142A76
            public Object getRowFieldByName( String name, AD4_CARATTERISTICHE_ACCESSORow row ) {
                ...
                } else if ( "GG_PRIMA_RIUTILIZZO_PWD".equals(name) ) {
                    value = row.getGG_PRIMA_RIUTILIZZO_PWD();
                } else if ( "GG_PRIMA_RIUTILIZZO_PWD_OLD".equals(name) ) {
                    value = row.getGG_PRIMA_RIUTILIZZO_PWD_OLD();
...
//AD4_CARATTERISTICHE_ACCESSO Record: method update body @38-AA136DE1
            if (!model.isAllowUpdate()) return;
            boolean isErrors = false;
            AD4_CARATTERISTICHE_ACCESSODataObject ds = new AD4_CARATTERISTICHE_ACCESSODataObject(page);
            ds.setComponent( model );
            ...
            row.setGG_PRIMA_RIUTILIZZO_PWD(Utils.convertToLong(model.getControl("GG_PRIMA_RIUTILIZZO_PWD").getValue()));
            try {
...
//AD4_CARATTERISTICHE_ACCESSO Record: method validate @38-5A73A078
        boolean validate() {
            ...
            com.codecharge.components.TextBox GG_PRIMA_RIUTILIZZO_PWD = (com.codecharge.components.TextBox) model.getChild( "GG_PRIMA_RIUTILIZZO_PWD" );
            if (! GG_PRIMA_RIUTILIZZO_PWD.validate()) { isControlError = true; }

            com.codecharge.components.Hidden GG_PRIMA_RIUTILIZZO_PWD_OLD = (com.codecharge.components.Hidden) model.getChild( "GG_PRIMA_RIUTILIZZO_PWD_OLD" );
            if (! GG_PRIMA_RIUTILIZZO_PWD_OLD.validate()) { isControlError = true; }
...
//AD4CaratteristicheAccesso Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AD4CaratteristicheAccesso Page: method validate

//AD4CaratteristicheAccessoAction Tail @1-FCB6E20C
}
//End AD4CaratteristicheAccessoAction Tail
