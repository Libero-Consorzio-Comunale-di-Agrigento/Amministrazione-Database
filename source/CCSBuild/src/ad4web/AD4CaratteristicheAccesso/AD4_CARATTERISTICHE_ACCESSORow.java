//AD4_CARATTERISTICHE_ACCESSORow: import @38-F31CD72D
...
//AD4_CARATTERISTICHE_ACCESSORow: declare fiels @38-EB00A1EE
    ...
    private LongField GG_PRIMA_RIUTILIZZO_PWD = new LongField("GG_PRIMA_RIUTILIZZO_PWD", "GG_PRIMA_RIUTILIZZO_PWD");
    private LongField GG_PRIMA_RIUTILIZZO_PWD_OLD = new LongField("GG_PRIMA_RIUTILIZZO_PWD_OLD", "GG_PRIMA_RIUTILIZZO_PWD_OLD");
...
//AD4_CARATTERISTICHE_ACCESSORow: method(s) of GG_PRIMA_RIUTILIZZO_PWD @260-55AC972A
    public LongField getGG_PRIMA_RIUTILIZZO_PWDField() {
        return GG_PRIMA_RIUTILIZZO_PWD;
    }

    public Long getGG_PRIMA_RIUTILIZZO_PWD() {
        return GG_PRIMA_RIUTILIZZO_PWD.getValue();
    }

    public void setGG_PRIMA_RIUTILIZZO_PWD(Long value) {
        this.GG_PRIMA_RIUTILIZZO_PWD.setValue(value);
    }
//End AD4_CARATTERISTICHE_ACCESSORow: method(s) of GG_PRIMA_RIUTILIZZO_PWD

//AD4_CARATTERISTICHE_ACCESSORow: method(s) of GG_PRIMA_RIUTILIZZO_PWD_OLD @261-8D5B9D8E
    public LongField getGG_PRIMA_RIUTILIZZO_PWD_OLDField() {
        return GG_PRIMA_RIUTILIZZO_PWD_OLD;
    }

    public Long getGG_PRIMA_RIUTILIZZO_PWD_OLD() {
        return GG_PRIMA_RIUTILIZZO_PWD_OLD.getValue();
    }

    public void setGG_PRIMA_RIUTILIZZO_PWD_OLD(Long value) {
        this.GG_PRIMA_RIUTILIZZO_PWD_OLD.setValue(value);
    }
//End AD4_CARATTERISTICHE_ACCESSORow: method(s) of GG_PRIMA_RIUTILIZZO_PWD_OLD
