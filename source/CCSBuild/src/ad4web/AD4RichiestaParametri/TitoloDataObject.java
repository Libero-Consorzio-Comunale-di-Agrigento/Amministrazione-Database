//Titolo DataSource @135-9C73F0C0
...
//class DataObject Header @135-99BC3D7C
public class TitoloDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @135-AB8B7AE1
    

    private TitoloRow[] rows = new TitoloRow[100];
...
//properties of DataObject @135-37590885
...
//loadDataBind @135-D82BA49C
        if ( records == null || ! records.hasMoreElements() ) {
            ...
            while ( counter < rows.length && records.hasMoreElements() ) {
                ...
                row.setNuovo(Utils.convertToString(ds.parse(record.get("1"), row.getNuovoField())));
                rows[counter++] = row;
            }
        }
//End loadDataBind
...
//getParameterByName @135-AE30C4C3
