//AD4DiacElencoView imports @1-A86F46BC
...
//End AD4DiacElencoView imports

//AD4DiacElencoView class @1-EB65B27E
public class AD4DiacElencoView extends View {
//End AD4DiacElencoView class

//AD4DiacElencoView: method show @1-1B02FA05
    public String show( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        this.page = (AD4DiacElencoModel) req.getAttribute( "AD4DiacElencoModel" );
        if (this.page == null) return "";
        String enc = (req.getAttribute(page.getName()+"Parent")!=null) ? ((com.codecharge.components.Page) req.getAttribute(page.getName()+"Parent")).getCharacterEncoding() : null;
        page.setCharacterEncoding("windows-1252");
        this.tmplPath = "/ad4web/AD4DiacElenco.html";
...
//End AD4DiacElencoView: method show
...
//RegioniFiltro Record @169-DE034928
...
//AD4DiacElencoView Tail @1-FCB6E20C
}
//End AD4DiacElencoView Tail
