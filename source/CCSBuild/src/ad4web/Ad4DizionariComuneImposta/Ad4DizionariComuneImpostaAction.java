//Ad4DizionariComuneImpostaAction imports @1-FE33C36A
...
//ComuneImposta Record: bind @5-8B5C31E0
...
//ComuneImposta Record: getRowFieldByName @5-3AADF458
...
//ComuneImposta Record: method insert body @5-25609132
            if (!model.isAllowInsert()) return;
            boolean isErrors = false;
            ComuneImpostaDataObject ds = new ComuneImpostaDataObject(page);
            ds.setComponent( model );
...
//ComuneImposta Record: method update body @5-FBC283DF
            if (!model.isAllowUpdate()) return;
            boolean isErrors = false;
            ComuneImpostaDataObject ds = new ComuneImpostaDataObject(page);
            ds.setComponent( model );
...
//ComuneImposta Record: method validate @5-9BECA807
        boolean validate() {
            model.fireOnValidateEvent();
            boolean isControlError = false;

            com.codecharge.components.TextBox PROVINCIA_STATO = (com.codecharge.components.TextBox) model.getChild( "PROVINCIA_STATO" );
