//Ad4DizionariComuneImpostaModel imports @1-CFDD2684
package ad4web.Ad4DizionariComuneImposta;
...
//ComuneImposta record @5-87D2626B
        ...
        */
        {
            ...
            com.codecharge.components.TextBox PROVINCIA_STATO__8 = new com.codecharge.components.TextBox("PROVINCIA_STATO", "PROVINCIA_STATO", this );
            ...
            com.codecharge.components.TextBox COMUNE__45 = new com.codecharge.components.TextBox("COMUNE", "PROVINCIA", this );
            COMUNE__45.setType( com.codecharge.components.ControlType.INTEGER );
            COMUNE__45.setHtmlEncode( true );
            COMUNE__45.setCaption( "Provincia" );
            COMUNE__45.addValidateHandler( new RequiredHandler( "Il valore nel campo Provincia è richiesto." ) );
            ...
            TRIBUNALE_DESC__52.addValidateHandler( new RequiredHandler( "Il valore nel campo Denominazione è richiesto." ) );
            ...
            FUSIONE_DESC__56.addValidateHandler( new RequiredHandler( "Il valore nel campo Denominazione è richiesto." ) );
            ...
            com.codecharge.components.Label LABEL_UPD__61 = new com.codecharge.components.Label("LABEL_UPD", "LABEL_UPD", this );
            LABEL_UPD__61.setType( com.codecharge.components.ControlType.TEXT );
            ComuneImposta.add(LABEL_UPD__61);
