//AD4Progetti_VSearch DataSource @6-3F17E0A6
...
//End AD4Progetti_VSearch DataSource

//class DataObject Header @6-D875FFDE
public class AD4Progetti_VSearchDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @6-B6F1C3E6
    

    TextField urlS_DESCRIZIONE = new TextField(null, null);
    

    private AD4Progetti_VSearchRow row = new AD4Progetti_VSearchRow();

//End attributes of DataObject

//properties of DataObject @6-0CCCC232
    ...
    public AD4Progetti_VSearchRow getRow() {
        return row;
    }

    public void setRow( AD4Progetti_VSearchRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @6-6B13CFC2
    public AD4Progetti_VSearchDataObject(Page page) {
        super(page);
    }
//End constructor
