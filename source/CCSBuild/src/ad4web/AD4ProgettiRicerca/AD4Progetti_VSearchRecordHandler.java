//AD4Progetti_VSearchHandler Head @6-4B52236B
...
public class AD4Progetti_VSearchRecordHandler implements RecordListener {
//End AD4Progetti_VSearchHandler Head

//BeforeShow Head @6-46046458
    public void beforeShow(Event e) {
//End BeforeShow Head

//Set values @6-4E8FFE4D
        e.getRecord().getLink("Nuovo").getParameter("SE_NUOVO").setValue(( "Y" ));
        e.getRecord().getLink("Nuovo").getParameter("MVVC").setValue(( "AD4PROGA" ));
//End Set values
...
//AD4Progetti_VSearchHandler Tail @6-FCB6E20C
}
//End AD4Progetti_VSearchHandler Tail
