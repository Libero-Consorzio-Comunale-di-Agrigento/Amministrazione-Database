//AD4_RUOLIDataObjectHandler head @23-6FB15F11
...
public class AD4_RUOLIDataObjectHandler implements RecordDataObjectListener {
//End AD4_RUOLIDataObjectHandler head
...
//Event AfterExecuteUpdate Action AD4RefreshSlaves @85-2B13205D
...
//Event AfterExecuteDelete Action AD4RefreshSlaves @86-2B13205D
if(!e.getRecord().hasErrors()){
    String retValue = "";
    String istanza = (String)SessionStorage.getInstance(e.getPage().getRequest()).getAttribute("Istanza");
    JDBCConnection conn = JDBCConnectionFactory.getJDBCConnection("cn");
...
//AD4_RUOLIDataObjectHandler Tail @23-FCB6E20C
}
//End AD4_RUOLIDataObjectHandler Tail
