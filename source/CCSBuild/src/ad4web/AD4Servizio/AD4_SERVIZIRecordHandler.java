//AD4_SERVIZIHandler Head @38-60BFDC79
...
public class AD4_SERVIZIRecordHandler implements RecordListener {
//End AD4_SERVIZIHandler Head

//BeforeShow Head @38-46046458
    public void beforeShow(Event e) {
//End BeforeShow Head

//Set values @38-45F95604
        if (! e.getRecord().isEditMode()) {
            e.getRecord().getControl("ABILITAZIONE").setDefaultValue("C");
            e.getRecord().getControl("MULTIPLO").setDefaultValue("N");
            e.getRecord().getControl("RECUPERO_PASSWORD").setDefaultValue("N");
        }
//End Set values
...
//AD4_SERVIZIHandler Tail @38-FCB6E20C
}
