//AD4SoggRicercaInclusa_origModel imports @1-98154C1A
...
//End AD4SoggRicercaInclusa_origModel imports

//AD4SoggRicercaInclusa_origModel class head @1-E8453C5C
public class AD4SoggRicercaInclusa_origModel extends com.codecharge.components.Page {
    public AD4SoggRicercaInclusa_origModel() {
        this( new CCSLocale(), null );
    }

    public AD4SoggRicercaInclusa_origModel(CCSLocale locale) {
        this( locale, null );
    }

    public AD4SoggRicercaInclusa_origModel( CCSLocale locale, HttpServletResponse response ) {
//End AD4SoggRicercaInclusa_origModel class head

//page settings @1-54E0A0DB
        super("AD4SoggRicercaInclusa_orig", locale );
...
//AD4Soggetti_VSearch record @6-F1F05A64
        ...
        */
        {
            ...
            AD4Soggetti_VSearch.setReturnPage("AD4SoggRicercaInclusa_orig" + Names.ACTION_SUFFIX);
            ...
            IMMAGINE_FILTRO__389.setHrefSourceValue( "/ad4web/AD4SoggRicercaInclusa_orig" + Names.ACTION_SUFFIX );
...
//AD4SoggRicercaInclusa_origModel class tail @1-F5FC18C5
    }
}
//End AD4SoggRicercaInclusa_origModel class tail
