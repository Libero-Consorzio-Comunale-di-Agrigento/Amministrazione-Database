//AD4SoggRicercaInclusa_origAction imports @1-10C0821A
...
//End AD4SoggRicercaInclusa_origAction imports

//AD4SoggRicercaInclusa_origAction class @1-DED63614
public class AD4SoggRicercaInclusa_origAction extends Action {

//End AD4SoggRicercaInclusa_origAction class

//AD4SoggRicercaInclusa_origAction: method perform @1-68093A5C
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AD4SoggRicercaInclusa_origModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AD4SoggRicercaInclusa_origModel", page );
...
//End AD4SoggRicercaInclusa_origAction: method perform

//AD4SoggRicercaInclusa_origAction: call children actions @1-C743B240
        if (result == null) {
...
//End AD4SoggRicercaInclusa_origAction: call children actions
...
//DoSearch Button @7-B5B4B0AA
        void DoSearchSearchAction() {
            ...
            page.setRedirectString( "AD4SoggRicercaInclusa_orig" + Names.ACTION_SUFFIX + "?" + page.getHttpGetParams().toString( excludeParams ) + "&" + page.getHttpPostParams().toString( buttonModel.getExcludeParams() ) );
...
//AD4SoggRicercaInclusa_orig Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AD4SoggRicercaInclusa_orig Page: method validate

//AD4SoggRicercaInclusa_origAction Tail @1-FCB6E20C
}
//End AD4SoggRicercaInclusa_origAction Tail
