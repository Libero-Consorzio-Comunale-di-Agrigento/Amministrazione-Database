//AslElenco DataSource @8-140B3C95
...
//attributes of DataObject @8-DD039A85
...
//properties of DataObject @8-D0ECD54E
...
//load @8-B0131227
    boolean load() {
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( select reg.denominazione regione_denominazione ,regione_asl ,codice_asl ,descrizione ,asl.utente_aggiornamento ,ad4_ccs.format_data_trunc(asl.data_aggiornamento) data_aggiornamento from ad4_asl asl ,ad4_regioni reg where asl.regione_asl = reg.regione and ( descrizione like upper('%'||'{s_ASL}')||'%' or codice_asl like '{s_ASL}'||'%' ) and ( regione = '{s_REGIONE}' or '{s_REGIONE}' is null )  ) cnt " );
