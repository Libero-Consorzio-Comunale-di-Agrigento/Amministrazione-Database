//AD4DirittoAccesso_OKModel imports @1-7AF8C0C0
...
//End AD4DirittoAccesso_OKModel imports

//AD4DirittoAccesso_OKModel class head @1-2C897878
public class AD4DirittoAccesso_OKModel extends com.codecharge.components.Page {
    public AD4DirittoAccesso_OKModel() {
        this( new CCSLocale(), null );
    }

    public AD4DirittoAccesso_OKModel(CCSLocale locale) {
        this( locale, null );
    }

    public AD4DirittoAccesso_OKModel( CCSLocale locale, HttpServletResponse response ) {
//End AD4DirittoAccesso_OKModel class head

//page settings @1-A0C7DA06
        super("AD4DirittoAccesso_OK", locale );
        setResponse(response);
        addPageListener(new AD4DirittoAccesso_OKPageHandler());
        {
            ...
            JS_REFRESH_SLAVES__165.addControlListener( new AD4DirittoAccesso_OKJS_REFRESH_SLAVESHandler());
            add( JS_REFRESH_SLAVES__165 );
        } // end page
//End page settings

//AD4_DIRITTI_ACCESSO1 record @38-E5A81EC3
        ...
        */
        {
            ...
            AD4_DIRITTI_ACCESSO1.setReturnPage("AD4DirittoAccesso_OK" + Names.ACTION_SUFFIX);
            ...
            com.codecharge.components.Hidden MODULO_ORIG__83 = new com.codecharge.components.Hidden("MODULO_ORIG", "MODULO", this );
            ...
            com.codecharge.components.Hidden ISTANZA_ORIG__84 = new com.codecharge.components.Hidden("ISTANZA_ORIG", "ISTANZA", this );
...
//AD4DirittoAccesso_OKModel class tail @1-F5FC18C5
    }
}
//End AD4DirittoAccesso_OKModel class tail
