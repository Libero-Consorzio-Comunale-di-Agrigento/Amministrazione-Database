//AD4_DIRITTI_ACCESSO1 DataSource @38-D26E51AD
...
//loadDataBind @38-7F0CD2FB
        if ( record == null || record.isEmpty() ) {
            ...
            row.setMODULO_ORIG(Utils.convertToString(ds.parse(record.get("MODULO"), row.getMODULO_ORIGField())));
            row.setISTANZA(Utils.convertToString(ds.parse(record.get("ISTANZA"), row.getISTANZAField())));
            row.setISTANZA_ORIG(Utils.convertToString(ds.parse(record.get("ISTANZA"), row.getISTANZA_ORIGField())));
