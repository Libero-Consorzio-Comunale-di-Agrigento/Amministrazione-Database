//AD4DirittoAccesso_OKAction imports @1-14D237F6
...
//End AD4DirittoAccesso_OKAction imports

//AD4DirittoAccesso_OKAction class @1-8238FC2C
public class AD4DirittoAccesso_OKAction extends Action {

//End AD4DirittoAccesso_OKAction class

//AD4DirittoAccesso_OKAction: method perform @1-EE20E07F
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AD4DirittoAccesso_OKModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AD4DirittoAccesso_OKModel", page );
...
//End AD4DirittoAccesso_OKAction: method perform

//AD4DirittoAccesso_OKAction: call children actions @1-2FD5C0D3
...
//End AD4DirittoAccesso_OKAction: call children actions
...
//AD4DirittoAccesso_OK Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AD4DirittoAccesso_OK Page: method validate

//AD4DirittoAccesso_OKAction Tail @1-FCB6E20C
}
//End AD4DirittoAccesso_OKAction Tail
